...
class RunDummyTravelModelZones(AbstractTravelModel):
    ...
    def run(self, config, year):
        ...
        TODO get zones dataset and create dummy traveldata output ...
...
if __name__ == "__main__":
    ...
    RunDummyTravelModelZones().run(resources, options.year)    
'''