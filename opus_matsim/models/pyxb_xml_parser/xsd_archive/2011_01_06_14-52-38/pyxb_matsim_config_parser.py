...
# Generated 2011-01-06 15:38:20.885668 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:9b8df199-19a2-11e0-a2d2-001b63930ac1')
...
urbansimParameterType._ContentModel = pyxb.binding.content.ContentModel(state_map = {
    ...
    , 5 : pyxb.binding.content.ContentModelState(state=5, is_final=False, transitions=[
        ...
        pyxb.binding.content.ContentModelTransition(next_state=7, element_use=urbansimParameterType._UseForTag(pyxb.namespace.ExpandedName(None, u'testParameter'))),
    ])
