...
class RunTravelModel(AbstractTravelModel):
    ...
    def __init__(self):
        ...
        self.matsim_config_path = None  # path to generated matsim config xml
    ...
    def run(self, config, year):
        ...
        if not os.path.exists(self.matsim_config_path):
            try: os.mkdir(self.matsim_config_path)
            except: pass
        self.matsim_config_name = config['project_name'] + "_matsim_config.xml"
        self.matsim_config_full = os.path.join( self.matsim_config_path, self.matsim_config_name  )
