...
from opus_matsim.models.org.constants import matsim4urbansim_v11_xsd_url, matsim4urbansim_v11_xsd_name
...
class UpdateBindingClass(object):
    ...
    def get_xsd_from_matsim_org(self):
        ...
        xsd_reposit = os.path.join(self.temp_dir, matsim4urbansim_v11_xsd_name)
        
        # load and store xsd
        xsd_loader = LoadXSD(matsim4urbansim_v11_xsd_url, xsd_reposit)
