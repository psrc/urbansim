...
# Generated 2012-04-19 11:19:34.862672 by PyXB version 1.1.3
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:c7573e6b-8a00-11e1-86f2-3c07544cd942')
...
class urbansimParameterType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element randomLocationDistributionRadiusForUrbanSimZone uses Python identifier randomLocationDistributionRadiusForUrbanSimZone
    __randomLocationDistributionRadiusForUrbanSimZone = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'randomLocationDistributionRadiusForUrbanSimZone'), 'randomLocationDistributionRadiusForUrbanSimZone', '__AbsentNamespace0_urbansimParameterType_randomLocationDistributionRadiusForUrbanSimZone', False)

    
    randomLocationDistributionRadiusForUrbanSimZone = property(__randomLocationDistributionRadiusForUrbanSimZone.value, __randomLocationDistributionRadiusForUrbanSimZone.set, None, None)
    ...
    _ElementMap = {
        ...
        __randomLocationDistributionRadiusForUrbanSimZone.name() : __randomLocationDistributionRadiusForUrbanSimZone,
...
class accessibilityParameterType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element accessibilityDestinationSamplingRate uses Python identifier accessibilityDestinationSamplingRate
    __accessibilityDestinationSamplingRate = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'accessibilityDestinationSamplingRate'), 'accessibilityDestinationSamplingRate', '__AbsentNamespace0_accessibilityParameterType_accessibilityDestinationSamplingRate', False)

    
    accessibilityDestinationSamplingRate = property(__accessibilityDestinationSamplingRate.value, __accessibilityDestinationSamplingRate.set, None, None)
    ...
    _ElementMap = {
        ...
        __accessibilityDestinationSamplingRate.name() : __accessibilityDestinationSamplingRate,
...
urbansimParameterType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'randomLocationDistributionRadiusForUrbanSimZone'), pyxb.binding.datatypes.double, scope=urbansimParameterType))
...
urbansimParameterType._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(urbansimParameterType._UseForTag(pyxb.namespace.ExpandedName(None, u'randomLocationDistributionRadiusForUrbanSimZone')), min_occurs=1, max_occurs=1),
...
accessibilityParameterType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'accessibilityDestinationSamplingRate'), pyxb.binding.datatypes.double, scope=accessibilityParameterType))
...
accessibilityParameterType._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(accessibilityParameterType._UseForTag(pyxb.namespace.ExpandedName(None, u'accessibilityDestinationSamplingRate')), min_occurs=1, max_occurs=1),
