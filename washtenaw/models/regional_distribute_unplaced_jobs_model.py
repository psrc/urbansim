...
from urbansim.models.distribute_unplaced_jobs_model import DistributeUnplacedJobsModel

class RegionalDistributeUnplacedJobsModel(DistributeUnplacedJobsModel):
    ...
    def run(self, location_set, agent_set, **kwargs):
        ...
        return DistributeUnplacedJobsModel.run(self, location_set, agent_set, agents_index, **kwargs)
...
class Test(opus_unittest.OpusTestCase):        
    def xtest_distribute_unplaced_jobs_model(self):
