...
from randstad.indicators.create_single_year_indicators import get_single_year_indicators
from randstad.indicators.create_single_year_indicators_for_many_years import get_single_year_indicators as get_single_year_indicators_for_many_years
from randstad.indicators.create_multiple_year_indicators import get_multiple_year_indicators
...
config = {
    'resources':{
        'input_configuration': DatabaseConfiguration(
            ...
            database_name = 'randstad_estimation_18_96_2006',
            ),
        },
    'datasets_to_preload':{
        'gridcell':{
...
#    }, 
    {'id':331,
     'cache_directory': 'L:/urbansim_cache/run_331.2006_04_21_22_23',
     'run_description': '(run 331 - no ugb 5/3)',
    },
#    {'id':332, 
...
single_year = 2030
many_single_year = [2000, 2001, 2005, 2006, 2030]
