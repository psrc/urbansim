...
"""
    _return_type="int32"
    zone_number_of_jobs = "number_of_jobs"
    
    def dependencies(self):
        return [attribute_label("zone", self.zone_number_of_jobs), attribute_label("zone", "faz_id")]
    
    def compute(self, dataset_pool):
        return self.get_dataset().sum_dataset_over_ids(dataset_pool.get_dataset('zone'), 
                self.zone_number_of_jobs)
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.faz.number_of_jobs"
