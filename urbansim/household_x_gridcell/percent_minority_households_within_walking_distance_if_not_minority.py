...
class percent_minority_households_within_walking_distance_if_not_minority(Variable):
    """Percent of households' heads within the walking radius that are in a minority race, given that the decision-making household's head is not in a minority race.
    [percent_minority_households_within_walking_distance if hh.is_minority is false else 0]"""
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.household_x_gridcell.percent_minority_households_within_walking_distance_if_not_minority"
    
    def test_full_tree(self):
        """Percent of households within walking distance that are minority, given that the 
        head of the decision-making household is not minority.
        (If the head of the decision-making household is minority the corresponding value is 0.)
        """
