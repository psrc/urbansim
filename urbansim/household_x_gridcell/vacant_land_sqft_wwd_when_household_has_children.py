...
class vacant_land_sqft_wwd_when_household_has_children(Variable):
    """vacan land sqft in the cell, given that the decision-making household has children.
    [if hh.children > 0 then cell.vacant_land_sqft else 0]"""    

    gc_vacant_land = "vacant_land_sqft_within_walking_distance"
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.household_x_gridcell.vacant_land_sqft_wwd_when_household_has_children"
    ...
    def test_full_tree(self):
        ...
        values = VariableTestToolbox().compute_variable(self.variable_name, \
            {"gridcell":{ \
                "vacant_land_sqft_within_walking_distance":sqft}, \
            "household":{ \
                "children":children}}, \
    ...
    def test_my_inputs(self):
        ...
        values = VariableTestToolbox().compute_variable(self.variable_name, \
            {"gridcell":{ \
                "vacant_land_sqft_within_walking_distance":residential_units}, \
            "household":{ \
