...
class trip_weighted_average_utility_hbw_from_home_am_income(Variable):
    """What is the trip_weighted_average_utility_hbw_from_home for this household. """
    _return_type="float32"
    # todo: how to not hard code the income values?
    gc_wauh_from_home_ai_1 = "trip_weighted_average_utility_hbw_from_home_am_income_1"
    gc_wauh_from_home_ai_2 = "trip_weighted_average_utility_hbw_from_home_am_income_2"
    gc_wauh_from_home_ai_3 = "trip_weighted_average_utility_hbw_from_home_am_income_3"
    gc_wauh_from_home_ai_4 = "trip_weighted_average_utility_hbw_from_home_am_income_4"
    ...
    def compute(self, dataset_pool):
        ...
        for income_type in range(1, 5):
            ...
            trip2Darray = self.get_dataset().get_2d_dataset_attribute('trip_weighted_average_utility_hbw_from_home_am_income_%d' % income_type)
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.household_x_gridcell.trip_weighted_average_utility_hbw_from_home_am_income"
