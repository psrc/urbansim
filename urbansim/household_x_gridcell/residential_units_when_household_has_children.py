...
class residential_units_when_household_has_children(Variable):
    ...
    gc_residential_units = "residential_units"
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.household_x_gridcell.residential_units_when_household_has_children"
