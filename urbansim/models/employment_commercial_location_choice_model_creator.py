...
class EmploymentCommercialLocationChoiceModelCreator(object):
    
    capacity_string_default = "vacant_commercial_job_space"
    estimation_weight_string_default = "total_number_of_possible_commercial_jobs"
    number_of_agents_string_default = "number_of_commercial_jobs"
    number_of_units_string_default = "total_number_of_possible_commercial_jobs"
    ...
    def get_model(self, location_set,
        ...
        return AgentLocationChoiceModel(location_set, 
                                        model_name="Commercial Employment Location Choice Model", 
                                        short_name="Comm ELCM", 
                                        sampler=sampler, 
                                        utilities=utilities, 
