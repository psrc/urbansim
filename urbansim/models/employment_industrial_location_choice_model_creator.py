...
class EmploymentIndustrialLocationChoiceModelCreator(object):
    
    capacity_string_default = "vacant_industrial_job_space"
    estimation_weight_string_default = "total_number_of_possible_industrial_jobs"
    number_of_agents_string_default = "number_of_industrial_jobs"
    number_of_units_string_default = "total_number_of_possible_industrial_jobs"
    ...
    def get_model(self, location_set,
        ...
        return AgentLocationChoiceModel(location_set,
                                        model_name="Industrial Employment Location Choice Model", 
                                        short_name="Ind ELCM", 
                                        sampler=sampler, 
                                        utilities=utilities, 
