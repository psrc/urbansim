...
class population_outside_ugb(Variable):
    ...
    def compute(self, dataset_pool):
        ...
        return self.get_dataset().sum_over_ids(gridcell.get_attribute("region_id"),
                                               ...
                                               gridcell.get_attribute("is_outside_urban_growth_boundary") )
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.region.population_outside_ugb"

    def test_my_inputs(self):
        outside = array([1,0,0,1])
        population = array([20,51,0,12])
