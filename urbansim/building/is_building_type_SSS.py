...
class is_building_type_SSS(Variable):
    ...
    def dependencies(self):
        return [attribute_label("building_type", "name")]
        
    def compute(self, dataset_pool):
        building_types = dataset_pool.get_dataset('building_type')
        code = building_types.get_code(self.building_type_name)
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.building.is_building_type_commercial"
