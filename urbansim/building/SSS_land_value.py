...
class SSS_land_value(Variable):
    """land_value of given type."""
    ...
    def dependencies(self):
        return [my_attribute_label(self.is_type_variable), 
                my_attribute_label("land_value")]

    def compute(self, dataset_pool):
        buildings = self.get_dataset()
        iv = buildings.get_attribute("land_value")
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.building.commercial_land_value"
