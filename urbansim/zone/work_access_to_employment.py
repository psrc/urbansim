...
class work_access_to_employment(Variable):
    ...
    def compute(self, dataset_pool):
        return self.get_dataset().get_attribute('ln_access_from_residence_to_workplaces_1') + \
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.zone.work_access_to_employment"
