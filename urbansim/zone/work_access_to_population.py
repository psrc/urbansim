...
class work_access_to_population(Variable):
    ...
    def compute(self, dataset_pool):
        return self.get_dataset().get_attribute('ln_home_access_to_population_income_1') + \
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim.zone.work_access_to_population"
