...
class average_income_when_has_DDD_to_DDD_units(Variable):
...
class Tests(opus_unittest.OpusTestCase):
    instance_name = "urbansim.gridcell.average_income_when_has_1_to_5_units"
    ...
    def test_my_inputs(self):
        ...
        should_be = array([1000.0, 10000.0, 0.0]) #would be a 2-D array if it spanned more than one "directory"
