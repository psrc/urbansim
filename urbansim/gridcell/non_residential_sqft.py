...
class non_residential_sqft(Variable):
    """Sum of commercial, industrial and governmental sqft for this gridcell."""
...
class Tests(opus_unittest.OpusTestCase):
    def test_my_inputs1(self):
        ...
        should_be = array([1100, 700, 800])
        tester.test_is_equal_for_variable_defined_by_this_module(self, should_be)

    def test_my_inputs2(self):
        total_nonres_sqft = array([100, 200, 300])
        commercial_sqft = array([100, 200, 300])
        governmental_sqft = array([1000, 400, 0])
        industrial_sqft = array([0, 100, 500])
