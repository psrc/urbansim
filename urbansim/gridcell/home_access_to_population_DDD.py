...
class home_access_to_population_DDD(Variable):
    ...
    be home_access_from_population_DDD instead.)"""
    def __init__(self, n):
        self.num_cars = n
        self.home_access_to_population = "home_access_to_population_"+str(self.num_cars)
        Variable.__init__(self)
 
    def dependencies(self):
        return [attribute_label("zone",self.home_access_to_population)] 
        
    def compute(self, dataset_pool):
        zones = dataset_pool.get_dataset('zone')
        return self.get_dataset().get_join_data(zones, name=self.home_access_to_population)
    ...
    def test_my_inputs(self):
        ...
        tester = VariableTester(
            ...
            test_data={
                "zone":{ 
                    "zone_id":array([1,2,3]),
                    "home_access_to_population_2":home_access_to_population
                    }, 
                "gridcell":{ 
