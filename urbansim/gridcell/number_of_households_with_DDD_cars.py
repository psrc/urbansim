...
class number_of_households_with_DDD_cars(Variable):
    """Sum the number of households for a given gridcell that have DDD cars"""
    _return_type="int32"
...
class Tests(opus_unittest.OpusTestCase):
    def test_my_inputs(self):
        ...
        instance_name = "urbansim.gridcell.number_of_households_with_1_cars"    
