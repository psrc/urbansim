...
class ln_home_access_to_population_DDD(Variable):
    ...
    def __init__(self, number):
        self.tnumber = number
        self.home_access_to_population = "home_access_to_population_"+str(self.tnumber)
        Variable.__init__(self)
    
    def dependencies(self):
        return [my_attribute_label(self.home_access_to_population)]
        
    def compute(self, dataset_pool):
        return ln_bounded(self.get_dataset().get_attribute(self.home_access_to_population))
