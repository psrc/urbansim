...
class developable_minimum_commercial_sqft(Variable):
    """The minimum number of commercial sqft that must be developed for each gridcell after applying
    development constraints.  Only development projects with at least this number of commercial sqft
    ...
    def compute(self, dataset_pool):
        ...
        result[where_developable] = (self.get_dataset().get_development_constrained_capacity(
            ...
            index=where_developable)["commercial"][:,0]).astype(self._return_type)
        return result
