...
class is_average_income_within_walking_distance_high_income_and_has_DDD_to_DDD_units(Variable):
    """"""
    ...
    def dependencies(self):
        return [my_attribute_label("is_average_income_within_walking_distance_high_income"),
                my_attribute_label("has_%s_to_%s_units" % (self.tnumber1, self.tnumber2))] 

    def compute(self, dataset_pool):
        return logical_and(self.get_dataset().get_attribute("is_average_income_within_walking_distance_high_income"),
