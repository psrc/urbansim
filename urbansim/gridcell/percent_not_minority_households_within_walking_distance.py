...
class percent_not_minority_households_within_walking_distance(Variable):
    """Percent of households within the walking radius that are designated as not minority.
    ...
    number_of_not_minority_households_within_walking_distance = "number_of_not_minority_households_within_walking_distance"
    number_of_households_within_walking_distance ="number_of_households_within_walking_distance"
    
    def dependencies(self):
        return [my_attribute_label(self.number_of_not_minority_households_within_walking_distance), 
    ...
    def compute(self, dataset_pool):
        ...
        return 100.0*ma.filled(self.get_dataset().get_attribute(self.number_of_not_minority_households_within_walking_distance)/ 
...
class Tests(opus_unittest.OpusTestCase):
    def test_my_inputs(self):
        number_of_not_minority_households_within_walking_distance = array([0, 333, 500, 100])
