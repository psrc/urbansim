...
class ln_work_access_to_employment_DDD(Variable):
    """Bounded natural log of the work_access_to_employment_DDD for this gridcell"""
    
    _return_type="float32"
          
    def __init__(self, number):
        self.tnumber = number
        self.work_access_to_employment = "work_access_to_employment_"+str(self.tnumber)
        Variable.__init__(self)
    
    def dependencies(self):
        return [my_attribute_label(self.work_access_to_employment)]
