...
class work_access_to_population_DDD(Variable):
    """The accessibility to jobs in the given grid cell from population for number of autos DDD.
    ...
    def __init__(self, n):
        self.num_cars = n
        self.work_access_to_population = "work_access_to_population_"+str(self.num_cars)
        Variable.__init__(self)
 
    def dependencies(self):
        return [attribute_label("zone",self.work_access_to_population)] 
        
    def compute(self, dataset_pool):
        zones = dataset_pool.get_dataset('zone')
        return self.get_dataset().get_join_data(zones, name=self.work_access_to_population)
...
class Tests(opus_unittest.OpusTestCase):
    def test_my_inputs(self):
        work_access_to_population = array([1000.0, 5000.0, 12000.0])
        ...
        instance_name = "urbansim.gridcell.work_access_to_population_2"
