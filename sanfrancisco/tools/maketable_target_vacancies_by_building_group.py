...
#===============================================================================
#Script creates target_vacancies table stratified by a grouping variable and
#publishes it to an instance of MySQL.
#1) Script connects to mysql database, deletes table target_vacancies
#2) Script creates new target_vacancies schema
#3)
#===============================================================================
...
#establish connection and read existing classification from local cache
