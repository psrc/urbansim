...
# 
# Also needs csv file with LOGRECNO (primary key in data files) to STFID (key in
# census tract OR blockgroup shape file--if script is to be run for both, then 
# both files must be present) as well as MS Access database (but the latter could
# easily be remedied as script used pyODBC and any database could potentially 
# be used). Unless the ArcGIS portion is disabled, script will also need a valid
# ESRI license to run.
#
...
# 
# Aksel Olsen, San Francisco Planning Department
#===============================================================================
