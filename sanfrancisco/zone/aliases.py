...
aliases = [
   ...
   "hhincq1 = zone.aggregate(sanfrancisco.household.in_adjusted_income_quartile_1, intermediates=[building,parcel])",
   "hhincq2 = zone.aggregate(sanfrancisco.household.in_adjusted_income_quartile_2, intermediates=[building,parcel])",
   "hhincq3 = zone.aggregate(sanfrancisco.household.in_adjusted_income_quartile_3, intermediates=[building,parcel])",
   "hhincq4 = zone.aggregate(sanfrancisco.household.in_adjusted_income_quartile_4, intermediates=[building,parcel])",
   "avgincq1 = safe_array_divide(zone.aggregate(where(sanfrancisco.household.in_adjusted_income_quartile_1,sanfrancisco.household.income_adjusted,0),intermediates=[building,parcel]),hhincq1)",
   "avgincq2 = safe_array_divide(zone.aggregate(where(sanfrancisco.household.in_adjusted_income_quartile_2,sanfrancisco.household.income_adjusted,0),intermediates=[building,parcel]),hhincq2)",
   "avgincq3 = safe_array_divide(zone.aggregate(where(sanfrancisco.household.in_adjusted_income_quartile_3,sanfrancisco.household.income_adjusted,0),intermediates=[building,parcel]),hhincq3)",
   "avgincq4 = safe_array_divide(zone.aggregate(where(sanfrancisco.household.in_adjusted_income_quartile_4,sanfrancisco.household.income_adjusted,0),intermediates=[building,parcel]),hhincq4)",
   "avginc_adj=zone.aggregate(sanfrancisco.household.income_adjusted, intermediates=[building,parcel], function=mean)",
