...
class class_name(Variable):
    """The class name (residential, nonresidential) of this building_use. """
   
    def dependencies(self):
        return [my_attribute_label("class_id"), 
    ...
    def compute(self,  dataset_pool):
        ...
        return self.get_dataset().get_join_data(building_class, name="name")
