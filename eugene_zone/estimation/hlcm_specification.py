...
specification = {
        -2:
            [
            ("urbansim.household_x_zone.ln_sampling_probability_for_bias_correction_mnl_vacant_residential_units", "bias", 1), # bias correction for sampling alternatives
            ...
            #('urbansim.household_x_zone.household_size_times_zone_average_household_size','BHHSxHHS'),
