...
from mag_zone.configs.controller_config import UrbansimZoneConfiguration
...
class Baseline(UrbansimZoneConfiguration):
    ...
    def __init__(self):
        ...
        config_changes = {
            'project_name':'mag_zone',
            'description':'MAG zone baseline',
            'base_year':2008,
            'years':(2009, 2009),
            'debuglevel': 4,
            'models': [
...
#                'distribute_unplaced_jobs_model',
            ...
            'dataset_pool_configuration': DatasetPoolConfiguration(
                package_order=['mag_zone', 'eugene', 'urbansim_zone', 'urbansim', 'opus_core'],
                ),
            }
