...
class CohabitationModel(AgentRelocationModel):
    ...
    def run(self, person_set, household_set, resources=None):
        ...
        ##TODO:  should we change the max_marriage_status in the rate table to 7 (if we want to keep cohabitaters as marriage_status = 7). can cohab household form from people who are cohabitating with others?
