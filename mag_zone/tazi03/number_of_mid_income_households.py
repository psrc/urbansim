...
class number_of_mid_income_households(Variable):
    ...
    def dependencies(self):
        return [attribute_label("household", self.is_mid_income, "mag_zone"), 
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "mag_zone.tazi03.number_of_mid_income_households"
    ...
    def test_full_tree(self):
        ...
        dataset_pool = DatasetPool(package_order=['urbansim'],
                                   storage=storage)
        zones = dataset_pool.get_dataset('tazi03')
