...
aliases = [
    "skyharbor_enplanement_capacity = (building.other_space_name=='skyharbor')*(building.other_spaces)",
    "williamsgateway_enplanement_capacity = (building.other_space_name=='williamsgateway')*(building.other_spaces)",
    "hotel_motel_rooms = (building.other_space_name=='hotel_motel_rooms')*(building.other_spaces)",
