...
aliases = [
    ...
    "bldg_du_constructed_this_year = building.residential_units-building.residential_units_lag1",
    ...
    "taz2012_id = building.disaggregate(zone.taz2012_id)",
...
#    "vacant_home_based_job_spaces = clip_to_zero(mag_zone.building.total_home_based_job_spaces - urbansim_zone.building.number_of_home_based_jobs)",
    ...
    "weight_for_gq_other_institutional = building.gq_pop_in_other_inst + building.gq_pop_in_other_noninst",  
    ...
    "weight_for_gq_prisons = building.gq_pop_in_prisons + building.gq_pop_in_juvenile_prisons", 
