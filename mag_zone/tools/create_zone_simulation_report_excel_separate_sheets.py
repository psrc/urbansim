...
class RegionWideReport():
    ...
    def get_percent_DUs_built(self):
        ...
        worksheet = self.workbook.add_sheet('r_pct_DUs_built_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
            row_counter += 1
        self.column_counter += 1

        worksheet.write(0,self.column_counter,'pct_DUs_built')
        row_counter = 1
        for year in self.years:
            ...
            for row in r:
                worksheet.write(row_counter,self.column_counter,row[0])
                row_counter += 1
            r.close()
    ...
    def get_percent_nonres_sqft_built(self):
        ...
        worksheet = self.workbook.add_sheet('r_pct_nres_sft_blt_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'pct_nonres_sqft_built')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_DUs_in_active_developments_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_DUs_in_actdev_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_ADM_DUs')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_nonres_sqft_in_active_developments_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_nressft_in_actdev_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_ADM_nonres_sqft')
        row_counter = 1
        for year in self.years:
    ...
    def get_mean_age_of_population_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_mean_pop_age_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'mean_pop_age')
        row_counter = 1
        for year in self.years:
    ...
    def get_median_age_of_population_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_median_pop_age_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'median_pop_age')
        row_counter = 1
        for year in self.years:
            ...
            worksheet.write(row_counter, self.column_counter, median_age)
            row_counter += 1
            r.close()
        self.column_counter =0
    ...
    def get_total_population_age_distribution_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_pop_age_distr_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter, 'pop_age_under_5')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'pop_age_5_9')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'pop_age_10_15')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'pop_age_16_18')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'pop_age_19_24')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'pop_age_25_34')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'pop_age_35_44')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'pop_age_45_54')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'pop_age_55_64')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'pop_age_over_65')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_male_population_distribution_by_age_and_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_mpop_age_distr_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter, 'm_pop_age_under_5')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_5_9')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_10_14')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_15_19')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_20_24')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_25_29')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_30_34')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_35_39')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_40_44')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_45_49')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_50_54')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_55_59')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_60_64')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_65_69')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_70_74')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_75_79')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_80_84')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_85_89')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_90_94')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_95_99')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'm_pop_age_100up')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_female_population_distribution_by_age_and_year(self):
        ...
        # 55-59, 60-64, 65-69, 70-74, 75-79, 80-84, 85-89, 90-94, 95-99, 100+
        worksheet = self.workbook.add_sheet('r_fpop_age_distr_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter, 'f_pop_age_under_5')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_5_9')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_10_14')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_15_19')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_20_24')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_25_29')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_30_34')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_35_39')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_40_44')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_45_49')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_50_54')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_55_59')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_60_64')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_65_69')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_70_74')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_75_79')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_80_84')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_85_89')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_90_94')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_95_99')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter, 'f_pop_age_100up')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_households_by_number_of_children(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_hhlds_by_noc_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        for year in self.years:
            ...
            r = self.connection.execute(query)
            r.close()
        worksheet.write(0,self.column_counter,'hh_0_children')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_1_children')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_2_children')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_3_children')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_4_children')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_5_children')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_6_children')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_7up_children')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_households_by_household_size(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_hhlds_by_size_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        for year in self.years:
            ...
            r = self.connection.execute(query)
            r.close()
        worksheet.write(0,self.column_counter,'hh_size_1')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_size_2')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_size_3')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_size_4')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_size_5')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_size_6')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter += 1
        worksheet.write(0,self.column_counter,'hh_size_7up')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_households_by_number_of_workers(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_hhlds_by_now_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'hh_0_workers')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter +=1
        worksheet.write(0,self.column_counter,'hh_1_worker')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter +=1
        worksheet.write(0,self.column_counter,'hh_2_workers')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter +=1
        worksheet.write(0,self.column_counter,'hh_3_workers')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter +=1
        worksheet.write(0,self.column_counter,'hh_4up_workers')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_workers_in_households(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_wrkrs_in_hhld_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'workers_in_hh')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_population_by_sex_and_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_pop_by_sex_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_male_pop')
        row_counter = 1
        for year in self.years:
            ...
            r.close()
        self.column_counter +=1
        worksheet.write(0,self.column_counter,'total_female_pop')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_DUs_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_DUs_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_DUs')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_nonres_sqft_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_nonres_sqft_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_nonres_sqft')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_nonres_sqft_by_type_and_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_nonres_sqft_by_type_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        for building_type in nonres_types:
            row_counter = 1
            worksheet.write(0,column_counter,'nonres_sqft_type_%s' % building_type)
            for year in self.years:
    ...
    def get_total_DUs_SF_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_SF_DUs_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_SF_DUs')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_DUs_MF_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_MF_DUs_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_MF_DUs')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_households_by_year(self):
        worksheet = self.workbook.add_sheet('r_ttl_hhlds_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_hh')
        row_counter = 1
        for year in self.years:
    ...
    def get_mean_household_income_by_year(self):
        worksheet = self.workbook.add_sheet('r_mean_hhld_inc_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'mean_hh_income')
        row_counter = 1
        for year in self.years:
    ...
    def get_mean_persons_per_household_by_year(self):
        worksheet = self.workbook.add_sheet('r_mean_pphh_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'mean_pp_per_hh')
        row_counter = 1
        for year in self.years:
    ...
    def get_median_household_income_by_year(self):
        worksheet = self.workbook.add_sheet('r_median_hhld_inc_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'median_hh_income')
        row_counter = 1
        for year in self.years:
            ...
            worksheet.write(row_counter, self.column_counter, median_income)
            row_counter += 1
            r.close()
        self.column_counter = 0

    def get_total_households_in_SFR_by_year(self):
        worksheet = self.workbook.add_sheet('r_ttl_SF_hhlds_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_hh_SFR')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_households_in_MFR_by_year(self):
        worksheet = self.workbook.add_sheet('r_ttl_MF_hhlds_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_hh_MFR')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_population_in_SFR_by_year(self):
        worksheet = self.workbook.add_sheet('r_ttl_SF_pop_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_pop_SFR')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_population_in_MFR_by_year(self):
        worksheet = self.workbook.add_sheet('r_ttl_MF_pop_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_pop_MFR')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_population_by_year(self):
        worksheet = self.workbook.add_sheet('r_total_pop_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_pop')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_jobs_by_year(self):
        worksheet = self.workbook.add_sheet('r_ttl_jobs_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_jobs')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_households_by_year_and_income_category(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_hhlds_by_inc_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_hh_income_0')
        row_counter = 1
        for year in self.years:
        ...
        worksheet.write(0,self.column_counter + 1,'total_hh_income_1')
        row_counter = 1
        for year in self.years:
            ...
            for row in r:
                worksheet.write(row_counter,self.column_counter + 1,row[0])
                row_counter += 1
            r.close()
        # households over 100k
        worksheet.write(0,self.column_counter + 2,'total_hh_income_2')
        row_counter = 1
        for year in self.years:
            ...
            for row in r:
                worksheet.write(row_counter,self.column_counter + 2,row[0])
                row_counter += 1
            r.close()
        self.column_counter = 0

    def get_houehold_control_totals_by_year(self):
        worksheet = self.workbook.add_sheet('r_hhld_ctr_ttl_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'household_ct')
        row_counter = 1
        ...
        for row in r:
            if row[0] == (self.base_year + 1):
                worksheet.write(row_counter,self.column_counter,0)
                row_counter += 1
                worksheet.write(row_counter,self.column_counter,row[1])
                row_counter += 1
            else:
                worksheet.write(row_counter,self.column_counter,row[1])
                row_counter += 1
    ...
    def get_job_control_totals_by_year(self):
        worksheet = self.workbook.add_sheet('r_job_ctr_ttl_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'job_ct')
        row_counter = 1
    ...
    def get_total_unplaced_development_projects_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_unplaced_dev_projs_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'unplaced_projects')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_unplaced_households_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_unplaced_hhlds_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'unplaced_hh')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_unplaced_households_by_income_categories(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_unplaced_hhlds_by_inc_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'unpl_hh_0_50k')
        row_counter = 1
        for year in self.years:
        ...
        worksheet.write(0,self.column_counter + 1,'unpl_hh_50_100k')
        row_counter = 1
        for year in self.years:
        ...
        worksheet.write(0,self.column_counter + 2,'unpl_hh_100k_up')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_unplaced_jobs_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_unplaced_jobs_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'unplaced_jobs')
        row_counter = 1
        for year in self.years:
    ...
    def get_total_unplaced_jobs_by_sector_and_year(self):
        ...
        # Get sectors
        worksheet = self.workbook.add_sheet('r_ttl_unplaced_jobs_by_sect_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        for sector in sectors:
            row_counter = 1
            worksheet.write(0,column_counter,'unpl_job_sec%s' % sector)
            for year in self.years:
    ...
    def get_total_jobs_by_sector_and_year(self):
        ...
        # Get sectors
        worksheet = self.workbook.add_sheet('r_ttl_jobs_by_sect_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        for sector in sectors:
            row_counter = 1
            worksheet.write(0,column_counter,'job_sec%s' % sector)
            for year in self.years:
    ...
    def get_total_population_by_race_and_year(self):
        ...
        # Get races
        worksheet = self.workbook.add_sheet('r_ttl_pop_by_race_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        for race in races:
            row_counter = 1
            worksheet.write(0,column_counter,'pop_race%s' % race)
            for year in self.years:
    ...
    def get_mean_persons_per_household_by_race_of_hh_head_and_year(self):
        ...
        # Get races
        worksheet = self.workbook.add_sheet('r_mean_pphh_by_headrace_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        for race in races:
            row_counter = 1
            worksheet.write(0,column_counter,'pphh_race%s' % race)
            for year in self.years:
    ...
    def get_mean_age_by_race_and_year(self):
        ...
        # Get races
        worksheet = self.workbook.add_sheet('r_mean_age_by_race_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        for race in races:
            row_counter = 1
            worksheet.write(0,column_counter,'mean_age_race%s' % race)
            for year in self.years:
    ...
    def get_total_job_spaces_by_year(self):
        ...
        worksheet = self.workbook.add_sheet('r_ttl_job_space_by_yr')
        worksheet.write(0,self.column_counter,'year')
        row_counter = 1
        for year in self.years:
            worksheet.write(row_counter,self.column_counter,year)
        ...
        worksheet.write(0,self.column_counter,'total_job_spaces')
        row_counter = 1           
        for year in self.years:
...
def get_total_children_in_hh_by_year_and_subarea(subarea, years, workbook, run_name, base_year, connection):
    # Get total households by subarea in a separate sheet
    # write column headings
    worksheet = workbook.add_sheet('total_kids_in_hh_by_%s_and_yr' % (subarea))
    worksheet.write(0,0,'%s_id' % (subarea))
    column_counter = 1
    for year in years:
        worksheet.write(0,column_counter,'y'+str(year))
    ...
    column_counter = 1
    for year in years:
        print('Computing total children in households by %s for year %s' % (subarea, year))
        row_counter = 1
        r = connection.execute("IF OBJECT_ID('tempdb..#distinct_%s','local') IS NOT NULL DROP TABLE #distinct_%s" % (subarea, subarea))
        r.close()
        r = connection.execute('select distinct(%s_id) into #distinct_%s from %s_%s_zones order by %s_id' % (subarea, subarea, run_name, base_year, subarea))
        r.close()
        query = '''select z.%s_id, sum(children) as numchildren
                    into #numchildren_%s
                    from %s_%s_households h
                    left join %s_%s_buildings b
                    on b.building_id = h.building_id
        ...
        r = connection.execute('''select
                            CASE 
                                    WHEN u.numchildren IS NULL THEN 0
                                    ELSE u.numchildren
                            END
                        from #distinct_%s r
                        left join #numchildren_%s u
                        on r.%s_id = u.%s_id
                        order by r.%s_id''' % (subarea, year, subarea, subarea, subarea))
        for row in r:
            worksheet.write(row_counter,column_counter,row[0])
...
def get_total_workders_in_hh_by_year_and_subarea(subarea, years, workbook, run_name, base_year, connection):
    # Get total households by subarea in a separate sheet
    # write column headings
    worksheet = workbook.add_sheet('total_wkers_in_hh_by_%s_and_yr' % (subarea))
    worksheet.write(0,0,'%s_id' % (subarea))
    column_counter = 1
    for year in years:
        worksheet.write(0,column_counter,'y'+str(year))
    ...
    column_counter = 1
    for year in years:
        print('Computing total workers in households by %s for year %s' % (subarea, year))
        row_counter = 1
        r = connection.execute("IF OBJECT_ID('tempdb..#distinct_%s','local') IS NOT NULL DROP TABLE #distinct_%s" % (subarea, subarea))
        r.close()
        r = connection.execute('select distinct(%s_id) into #distinct_%s from %s_%s_zones order by %s_id' % (subarea, subarea, run_name, base_year, subarea))
        r.close()
        query = '''select z.%s_id, sum(workers) as numworkers
                    into #numworkers_%s
                    from %s_%s_households h
                    left join %s_%s_buildings b
                    on b.building_id = h.building_id
        ...
        r = connection.execute('''select
                            CASE 
                                    WHEN u.numworkers IS NULL THEN 0
                                    ELSE u.numworkers
                            END
                        from #distinct_%s r
                        left join #numworkers_%s u
                        on r.%s_id = u.%s_id
                        order by r.%s_id''' % (subarea, year, subarea, subarea, subarea))
        for row in r:
            worksheet.write(row_counter,column_counter,row[0])
...
def get_mean_pop_age_by_year_and_subarea(subarea, years, workbook, run_name, base_year, connection):
    # Get total households by subarea in a separate sheet
    # write column headings
    worksheet = workbook.add_sheet('mean_pop_age_by_%s_and_year' % (subarea))
    worksheet.write(0,0,'%s_id' % (subarea))
    column_counter = 1
    for year in years:
        worksheet.write(0,column_counter,'y'+str(year))
    ...
    column_counter = 1
    for year in years:
        print('Computing mean pop age by %s for year %s' % (subarea, year))
        row_counter = 1
        r = connection.execute("IF OBJECT_ID('tempdb..#distinct_%s','local') IS NOT NULL DROP TABLE #distinct_%s" % (subarea, subarea))
        r.close()
        r = connection.execute('select distinct(%s_id) into #distinct_%s from %s_%s_zones order by %s_id' % (subarea, subarea, run_name, base_year, subarea))
        r.close()
        query = '''select z.%s_id, round(AVG(cast(age as float)),1) as avg_age
                    into #avg_age_%s
                    from %s_%s_persons h
                    left join %s_%s_households a
                    ...
                    on b.zone_id = z.zone_id
                    group by z.%s_id
                    order by z.%s_id''' % (subarea, year, run_name, year, run_name, year, run_name, year, run_name, year, subarea, subarea)
        r = connection.execute(query)
        r.close()
        r = connection.execute('''select
                            CASE 
                                    WHEN u.avg_age IS NULL THEN 0
                                    ELSE u.avg_age
                            END
                        from #distinct_%s r
                        left join #avg_age_%s u
                        on r.%s_id = u.%s_id
                        order by r.%s_id''' % (subarea, year, subarea, subarea, subarea))
        for row in r:
            worksheet.write(row_counter,column_counter,row[0])
...
def get_mean_adult_edu_by_year_and_subarea(subarea, years, workbook, run_name, base_year, connection):
    # Get total households by subarea in a separate sheet
    # write column headings
    worksheet = workbook.add_sheet('mean_adult_edu_by_%s_and_year' % (subarea))
    worksheet.write(0,0,'%s_id' % (subarea))
    column_counter = 1
    for year in years:
        worksheet.write(0,column_counter,'y'+str(year))
    ...
    column_counter = 1
    for year in years:
        print('Computing mean adult edu by %s for year %s' % (subarea, year))
        row_counter = 1
        r = connection.execute("IF OBJECT_ID('tempdb..#distinct_%s','local') IS NOT NULL DROP TABLE #distinct_%s" % (subarea, subarea))
        r.close()
        r = connection.execute('select distinct(%s_id) into #distinct_%s from %s_%s_zones order by %s_id' % (subarea, subarea, run_name, base_year, subarea))
        r.close()
        query = '''select z.%s_id, round(AVG(cast(education as float)),1) as avg_edu
                    into #avg_edu_%s
                    from %s_%s_persons h
                    left join %s_%s_households a
                    on a.household_id = h.household_id 
        ...
        r = connection.execute('''select
                            CASE 
                                    WHEN u.avg_edu IS NULL THEN 0
                                    ELSE u.avg_edu
                            END
                        from #distinct_%s r
                        left join #avg_edu_%s u
                        on r.%s_id = u.%s_id
                        order by r.%s_id''' % (subarea, year, subarea, subarea, subarea))
        for row in r:
            worksheet.write(row_counter,column_counter,row[0])
...
def get_total_female_by_year_and_subarea(subarea, years, workbook, run_name, base_year, connection):
    # Get total households by subarea in a separate sheet
    # write column headings
    worksheet = workbook.add_sheet('total_females_by_%s_and_year' % (subarea))
    worksheet.write(0,0,'%s_id' % (subarea))
    column_counter = 1
    for year in years:
        worksheet.write(0,column_counter,'y'+str(year))
    ...
    column_counter = 1
    for year in years:
        print('Computing total females by %s for year %s' % (subarea, year))
        row_counter = 1
        r = connection.execute("IF OBJECT_ID('tempdb..#distinct_%s','local') IS NOT NULL DROP TABLE #distinct_%s" % (subarea, subarea))
        r.close()
        r = connection.execute('select distinct(%s_id) into #distinct_%s from %s_%s_zones order by %s_id' % (subarea, subarea, run_name, base_year, subarea))
        r.close()
        query = '''select z.%s_id, count(*) as num_females
                    into #num_females_%s
                    from %s_%s_persons h
                    left join %s_%s_households a
                    on a.household_id = h.household_id 
        ...
        r = connection.execute('''select
                            CASE 
                                    WHEN u.num_females IS NULL THEN 0
                                    ELSE u.num_females
                            END
                        from #distinct_%s r
                        left join #num_females_%s u
                        on r.%s_id = u.%s_id
                        order by r.%s_id''' % (subarea, year, subarea, subarea, subarea))
        for row in r:
            worksheet.write(row_counter,column_counter,row[0])
...
def get_total_male_by_year_and_subarea(subarea, years, workbook, run_name, base_year, connection):
    # Get total households by subarea in a separate sheet
    # write column headings
    worksheet = workbook.add_sheet('total_males_by_%s_and_year' % (subarea))
    worksheet.write(0,0,'%s_id' % (subarea))
    column_counter = 1
    for year in years:
        worksheet.write(0,column_counter,'y'+str(year))
    ...
    column_counter = 1
    for year in years:
        print('Computing total males by %s for year %s' % (subarea, year))
        row_counter = 1
        r = connection.execute("IF OBJECT_ID('tempdb..#distinct_%s','local') IS NOT NULL DROP TABLE #distinct_%s" % (subarea, subarea))
        r.close()
        r = connection.execute('select distinct(%s_id) into #distinct_%s from %s_%s_zones order by %s_id' % (subarea, subarea, run_name, base_year, subarea))
        r.close()
        query = '''select z.%s_id, count(*) as num_males
                    into #num_males_%s
                    from %s_%s_persons h
                    left join %s_%s_households a
                    on a.household_id = h.household_id 
        ...
        r = connection.execute('''select
                            CASE 
                                    WHEN u.num_males IS NULL THEN 0
                                    ELSE u.num_males
                            END
                        from #distinct_%s r
                        left join #num_males_%s u
                        on r.%s_id = u.%s_id
                        order by r.%s_id''' % (subarea, year, subarea, subarea, subarea))
        for row in r:
            worksheet.write(row_counter,column_counter,row[0])
    ...
    while True:
        ...
        if subarea != '':
            report_list.extend(
                        ...
                        , 'get_total_children_in_hh_by_year_and_subarea'
                        , 'get_mean_pop_age_by_year_and_subarea'
                        , 'get_mean_adult_edu_by_year_and_subarea'
                        , 'get_total_female_by_year_and_subarea'
                        , 'get_total_male_by_year_and_subarea'
                        , 'get_total_workders_in_hh_by_year_and_subarea'
                        ]
                               )
        report_list.sort()
