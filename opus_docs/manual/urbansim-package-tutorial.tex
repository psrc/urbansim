...
\mysqlindex\index{Storage!sql}

This storage class allows writing and reading to a database. The first step is
to create a connection to a database. The parameters hostname, username, and
password to DatabaseServerConfiguration are actually only necessary if you are
trying to connect to a database that cannot be accessed via the server
information that you have specified in your environment variables.
