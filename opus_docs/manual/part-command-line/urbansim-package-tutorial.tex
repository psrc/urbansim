...
We can also plot a histogram{\index{histogram}\index{plotting!histogram}} of the income attribute \attributesindex (this method requires the
...
In order to use this model, we need to create a dataset \datasetindex with the two required attributes for means and variances.
