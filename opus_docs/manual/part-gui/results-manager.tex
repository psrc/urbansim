...
\emph{Number of Color Ranges}\index{Mapnik!color ranges}. 
...
\emph{Color Scaling Type}\index{Mapnik!color scaling type}. 
...
\emph{Custom Scale}\index{Mapnik!custom scale}. 
