...
\part{The Opus Graphical User Interface}\label{part-overview}
\input{part-gui/introduction}
\input{part-gui/xml-projects}
\input{part-gui/variable-library}
\input{part-gui/menu-bar}
\input{part-gui/general}
\input{part-gui/data-manager}
\input{part-gui/models-manager}
\input{part-gui/scenarios-manager}
\input{part-gui/results-manager}
