...
Variables, and the datasets on which they are computed, are explained in
considerably more detail in Chapters \ref{chap:data-in-opus} and
\ref{chap:creating-variables}.  Briefly for now, there are three ways to
define a variable:
