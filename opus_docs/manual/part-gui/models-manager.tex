...
Right-click on the variables node, and it should open a window that is essentially the same as the variables library window you encountered earlier.  The only difference is that in this case, 
