...
a \file{base_year_data} folder, and a \file{runs} folder.  The
base_year_data folder will normally contain an Opus \file{database} folder.
An Opus database folder is any folder containing Opus \file{datasets}.
...
in a model and would be computed as needed.  See Section
\ref{sec:expressions} on expressions for more details on expressions.
