...
types and Python types currently is defined for MySQL\index{MySQL}
...
indicators, which is no longer used in recent versions of the system. You do not need to create
...
In the PSRC\index{PSRC} application, the input tables for estimation are:
