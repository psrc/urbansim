...
\part{Appendices}
\input{appendicies/installation}
\input{appendicies/python-overview}
\input{appendicies/opus-core-selected-methods}
\input{appendicies/gnu-free-documentation-license}
\input{appendicies/glossary}
