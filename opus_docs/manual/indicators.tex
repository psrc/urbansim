...
\code{population} is computed, even for
...
\begin{itemize}
\tight
\item \code{2 * urbansim.gridcell.population + 1}
\item \code{urbansim.gridcell.residential_units + urbansim.gridcell.commercial_units}
\end{itemize}
...
\begin{itemize}
\tight
\item {\bf \code{table}} \index{tables} produce a table \index{tables} of indicator \indicatorsindex values
\item {\bf \code{chart}} \index{charts} produce a chart \index{charts} or graph \index{graphs} using matplotlib \matplotlibindex
\item {\bf \code{map}} \index{maps} produce a choropleth map \index{maps} using matplotlib \matplotlibindex
\item {\bf \code{dataset_table}} produces a table for every specified year 
