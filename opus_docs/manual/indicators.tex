...
This field is optional, although every indicator will then need to individually
specify a years parameter to its constructor. 
...
# Note that the years parameter is optional if years is defined in source_data. 
\end{verbatim}
