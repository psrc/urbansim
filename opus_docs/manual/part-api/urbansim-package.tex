...
%
The \class{LandPriceModel} \index{class!LandPriceModel} 
...
the model is a child of the \class{RegressionModel} \index{class!RegressionModel} described in
...
\index{Corrected Land Price Model}\index{class!CorrectedLandPriceModel}
%
This child model of \class{LandPriceModel} \index{class!LandPriceModel} makes a
...
\index{Residential Land Share Model}\index{class!ResidentialLandShareModel}
...
The \class{HousingPriceModel} \index{class!HousingPriceModel} 
...
The \class{RealEstatePriceModel} \index{class!RealEstatePriceModel}
...
\index{class!RegressionModelWithInitialResiduals}
described in
...
\index{class!LocationChoiceModel}

A location choice model is a choice model where the set of alternatives is a
set of locations.

The class \class{LocationChoiceModel} is a child of \class{ChoiceModel} \index{class!ChoiceModel}
...
\index{class!DevelopmentProjectLocationChoiceModel}
%
...
\class{LocationChoiceModel} \index{class!LocationChoiceModel} described in
...
The class\\
\class{DevelopmentProjectLocationChoiceModelCreator} \index{class!DevelopmentProjectLocationChoiceModelCreator} 
sets useful default
...
\index{class!AgentLocationChoiceModel}

The class \class{AgentLocationChoiceModel} is a child
of \class{LocationChoiceModel}\index{class!LocationChoiceModel} described in
...
\index{class!HouseholdLocationChoiceModel}
is an Agent Location Choice Model \index{class!AgentLocationChoiceModel} that makes default settings
of various arguments usable in the context of households
choosing their locations. The model is initiated with the arguments and their default values
...
\index{class!AgentLocationChoiceModelMember}
%
This model is a child of \class{AgentLocationChoiceModel} \index{class!AgentLocationChoiceModel}
...
The class is initialized by passing the following arguments:
\begin{description}
\item[group_member] - An object of class \class{ModelGroupMember}\index{class!ModelGroupMember} (see Section~\ref{sec:model-group}) 
...
%
The class \class{EmploymentLocationChoiceModel} \index{class!EmploymentLocationChoiceModel} 
is a child of \class{AgentLocationChoiceModelMember}. \index{model group}\index{class!AgentLocationChoiceModelMember}
...
%
The class \class{BuildingLocationChoiceModel} \index{class!BuildingLocationChoiceModel} 
is a child of \class{AgentLocationChoiceModelMember}. \index{model group}\index{class!AgentLocationChoiceModelMember}
Its default settings
...
The class \class{HouseholdTransitionModel} \index{class!HouseholdTransitionModel}
...
The class \class{EmploymentTransitionModel} \index{class!EmploymentTransitionModel} creates and removes jobs to and
...
$n$ in the variable \variablesindex names is the sector id. If you use
...
\index{class!DevelopmentProjectTransitionModel}
...
\index{class!DevelopmentEventTransitionModel}
...
%
This model (implemented in class  \class{ProcessPrescheduledDevelopmentEvents}\index{class!ProcessPrescheduledDevelopmentEvents})
...
The model (implemented in the class \class{BuildingTransitionModel}) \index{class!BuildingTransitionModel}
...
described in Section~\ref{sec:development-project-transition-model}. The process of creating buildings is done 
per building types, e.g.  'industrial' or
'commercial'.  The distribution of building sizes is determined by sampling from 
the projects obtained from the history.
...
%
The class \class{EventsCoordinator}\index{class!EventsCoordinator} updates a location set to reflect changes
...
%
\index{class!EventsCoordinatorAndStoring}
...
%
The class \class{ScalingJobsModel}\index{class!ScalingJobsModel} locates jobs to locations according to the
distribution of job sectors in locations.
\subsubsection{Initialization}
The model is initialized by passing the following arguments:
\begin{description}
\item[group_member] - An object of class \class{ModelGroupMember}\index{class!ModelGroupMember} 
...
\index{class!DistributeUnplacedJobsModel}
%
This model is a child of the \class{ScalingJobsModel}\index{class!ScalingJobsModel}. It determines all unplaced jobs, i.e.
...
The class \class{AgentRelocationModel}\index{class!AgentRelocationModel} 
...
\begin{itemize}
\item \class{HouseholdRelocationModelCreator}\index{class!HouseholdRelocationModelCreator} - sets the argument
...
\item \class{EmploymentRelocationModelCreator}\index{class!EmploymentRelocationModelCreator} - sets the argument
...
This section describes \class{Probabilitites}\index{class!Probabilities} classes (see
