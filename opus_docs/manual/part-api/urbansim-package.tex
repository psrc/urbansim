...
sample (with replacement) 10 existing households from the 3 bins within F (formed by groups
on the axis ``age_of_head'') and duplicate them.  If the difference between control total
