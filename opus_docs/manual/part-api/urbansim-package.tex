...
%% cross-reference commented out until it's defined (again)
%% As described in Chapter \ref{chapter:using-urbansim}, not all 
%% of these component models are required to run UrbanSim ...
...
are defined as children of the Opus \package{opus_core} class \class{Variable} \variablesindex and
...
\htmlonly{\includegraphics[scale=0.5, angle=-90]{images/urbansimmodels.jpg}}
\end{center}
\end{figure}
...
%% \subsection{Classifying Models by their Underlying Theory}

%% The models can also be grouped by their theoretical nature:

%% \begin{itemize}
%% \tight
%% \item {\bf Accounting Models}
%%   \begin{itemize}
%%   \tight
%%   \item Household transition model
%%   \item Employment transition model
%%   \item Development project transition_model
%%   \item Scaling jobs model
%%   \end{itemize}

%% \item {\bf Linear Regression Models}
%%   \begin{itemize}
%%   \tight
%%     \item Land price model
%%     \item Residential land share model
%%  \end{itemize}
%% \item {\bf Probabilistic Choice Models}
%%   \begin{itemize}
%%   \tight
%%   \item {\bf Rate Based Models}
%%     \begin{itemize}
%%     \tight
%%     \item Household relocation model
%%     \item Employment relocation model
%%     \end{itemize}
%%   \item {\bf Logit Models}
%%     \begin{itemize}
%%     \tight
%%     \item Household location choice model
%%     \item Industrial employment location choice model
%%     \item Commercial employment location choice model
%%     \item Home-based employment location choice model
%%     \item Industrial development project location choice model
%%     \item Commercial development project location choice model
%%     \item Residential development project location choice model
%%     \end{itemize}
%%   \end{itemize}
%% \end{itemize}
...
invokes every year a model \modelsindex called \class{CorrectLandValue}. This model \modelsindex makes a
correction of the land value to avoid its declination with development type
change.

Its \method{run()} method determines those members of \class{dataset} \datasetindex whose
...
returns an index of the modified \class{dataset} \datasetindex members.
...
%
The model \modelsindex can be created using pre-defined creators in \package{urbansim}.
The class\\
...
\class{DevelopmentProjectLocationChoiceModelCreator} \modelsindex is used by
\begin{itemize}
\item \class{DevelopmentProjectCommercialLocationChoiceModelCreator} \modelsindex
\item \class{DevelopmentProjectIndustrialLocationChoiceModelCreator} \modelsindex
\item \class{DevelopmentProjectResidentialLocationChoiceModelCreator} \modelsindex
\end{itemize}
