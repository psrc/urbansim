...
which are then plugged into \class{estimate_linear_regression}.
...
\label{sec:resources} \index{Configuration} \index{Resources} \index{GeneralResources}\index{ChunkSpecification}
%
...
\item[ChunkSpecification] - class for configuring chunks used by the \class{ChunkModel} (see 
