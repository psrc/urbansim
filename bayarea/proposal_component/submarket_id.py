...
class submarket_id(Variable):
    ...
    def dependencies(self):
        definitions = SubmarketDataset.subgroup_definition
        sub_dataset = lambda x: re.sub(r'building\.', r'proposal_component.', x)
...
SubmarketDataset.subgroup_definition = ['building.zone_id', 'building.building_type_id', 'building.tenure_id']
