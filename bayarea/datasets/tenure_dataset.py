...
class TenureDataset(SubgroupDataset):
    
    id_name_default = 'tenure_id'
    in_table_name_default = "tenure"
    out_table_name_default = "tenure"
    dataset_name = "tenure"
    subgroup_definition = ['bayarea.building.tenure_id']
