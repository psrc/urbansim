...
# 
#        storage.write_table(table_name='pdas',
#            table_data={
...
class TestPdaDataset(opus_unittest.OpusTestCase):
    def test_input1(self):
        ...
        ds = PdaDataset(subgroup_definition=['parcel.parcel_id'], in_storage=storage)
        
        self.assertEqual(ds.get_id_name(), ['pda_id'])
