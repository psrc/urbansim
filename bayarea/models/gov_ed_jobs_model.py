...
class TestModel(Model):
    ...
    def run(self):
        ...
        zone_set.add_primary_attribute(name='zone_pop', data=zone_pop)

        zone_set.add_primary_attribute(name='local_gov_jobs', data=local_gov_jobs)

        zone_set.add_primary_attribute(name='local_ed_k12_jobs', data=local_ed_k12_jobs)

        zone_set.add_primary_attribute(name='county_gov_jobs', data=county_gov_jobs)

        zone_set.add_primary_attribute(name='state_gov_jobs', data=state_gov_jobs)

        zone_set.add_primary_attribute(name='fed_gov_jobs', data=fed_gov_jobs)

        zone_set.add_primary_attribute(name='ed_high_jobs', data=ed_high_jobs)
