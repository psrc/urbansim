...
aliases = [
   ...
   "total_job_spaces = safe_array_divide(bayarea.employment_submarket.non_residential_sqft, employment_submarket.disaggregate(building_sqft_per_employee.building_sqft_per_employee))",
