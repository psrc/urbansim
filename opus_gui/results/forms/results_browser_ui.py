...
#
# Created: Fri Aug 22 19:54:31 2008
...
class Ui_ResultsBrowser(object):
    def setupUi(self, ResultsBrowser):
        ...
        self.twVisualizations.setGeometry(QtCore.QRect(10, 350, 781, 631))
        ...
        self.twVisualizations.setBaseSize(QtCore.QSize(40, 0))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(220, 30, 82, 171))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lstYears.setBaseSize(QtCore.QSize(40, 0))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(11, 30, 201, 171))
        ...
        self.lstAvailableRuns.setBaseSize(QtCore.QSize(100, 0))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(306, 30, 461, 171))
        ...
        self.label_2.setBaseSize(QtCore.QSize(500, 0))
        ...
        self.tableWidget.setBaseSize(QtCore.QSize(500, 0))
        ...
        self.groupBox = QtGui.QGroupBox(ResultsBrowser)
        self.groupBox.setGeometry(QtCore.QRect(350, 220, 441, 121))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 30, 421, 76))
        ...
        self.groupBox_2 = QtGui.QGroupBox(ResultsBrowser)
        self.groupBox_2.setGeometry(QtCore.QRect(12, 220, 321, 121))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 30, 301, 62))
    ...
    def retranslateUi(self, ResultsBrowser):
        ...
        self.groupBox.setTitle(QtGui.QApplication.translate("ResultsBrowser", "Current indicator", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.lblViewIndicator.setText(QtGui.QApplication.translate("ResultsBrowser", "None", None, QtGui.QApplication.UnicodeUTF8))
        self.lblViewYear.setText(QtGui.QApplication.translate("ResultsBrowser", "None", None, QtGui.QApplication.UnicodeUTF8))
        self.lblViewRun.setText(QtGui.QApplication.translate("ResultsBrowser", "None", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.cbAutoGen.setText(QtGui.QApplication.translate("ResultsBrowser", "  Auto  gen. results", None, QtGui.QApplication.UnicodeUTF8))
