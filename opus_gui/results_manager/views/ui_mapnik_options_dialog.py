...
# Form implementation generated from reading ui file 'map_options2.ui'
#
# Created: Mon Apr 13 12:01:28 2009
...
class Ui_Mapnik_Options(object):
    def setupUi(self, Mapnik_Options):
        ...
        Mapnik_Options.resize(473, 642)
        self.verticalLayout = QtGui.QVBoxLayout(Mapnik_Options)
        self.verticalLayout.setObjectName("verticalLayout")
        self.formLayout = QtGui.QFormLayout()
        self.formLayout.setFieldGrowthPolicy(QtGui.QFormLayout.AllNonFixedFieldsGrow)
        self.formLayout.setObjectName("formLayout")
        self.label = QtGui.QLabel(Mapnik_Options)
        self.label.setObjectName("label")
        self.formLayout.setWidget(0, QtGui.QFormLayout.LabelRole, self.label)
        self.cb_NumColRanges = QtGui.QComboBox(Mapnik_Options)
        ...
        self.line = QtGui.QFrame(Mapnik_Options)
        self.line.setLineWidth(0)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName("line")
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.line)
        self.label_2 = QtGui.QLabel(Mapnik_Options)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.label_2)
        self.cb_colorScalingType = QtGui.QComboBox(Mapnik_Options)
        ...
        self.label_3 = QtGui.QLabel(Mapnik_Options)
        self.label_3.setObjectName("label_3")
        self.formLayout.setWidget(3, QtGui.QFormLayout.LabelRole, self.label_3)
        self.le_customScale = QtGui.QLineEdit(Mapnik_Options)
        ...
        self.label_9 = QtGui.QLabel(Mapnik_Options)
        self.label_9.setObjectName("label_9")
        self.formLayout.setWidget(6, QtGui.QFormLayout.LabelRole, self.label_9)
        self.le_customLabels = QtGui.QLineEdit(Mapnik_Options)
        ...
        self.label_10 = QtGui.QLabel(Mapnik_Options)
        self.label_10.setObjectName("label_10")
        self.formLayout.setWidget(9, QtGui.QFormLayout.LabelRole, self.label_10)
        self.cb_divergeIndex = QtGui.QComboBox(Mapnik_Options)
        ...
        self.label_7 = QtGui.QLabel(Mapnik_Options)
        self.label_7.setObjectName("label_7")
        self.formLayout.setWidget(10, QtGui.QFormLayout.LabelRole, self.label_7)
        self.cb_colorSchemeNeg = QtGui.QComboBox(Mapnik_Options)
        ...
        self.tbl_Colors.setMinimumSize(QtCore.QSize(321, 326))
        ...
        self.formLayout.setWidget(12, QtGui.QFormLayout.FieldRole, self.tbl_Colors)
        self.verticalLayout.addLayout(self.formLayout)
        spacerItem = QtGui.QSpacerItem(20, 5, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        self.verticalLayout.addItem(spacerItem)
        self.horizontalLayout = QtGui.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.pb_applyChanges = QtGui.QPushButton(Mapnik_Options)
        ...
        self.pb_closeWindow = QtGui.QPushButton(Mapnik_Options)
