...
class Ui_dlgGetRunInfo(object):
    ...
    def retranslateUi(self, dlgGetRunInfo):
        dlgGetRunInfo.setWindowTitle(QtWidgets.QApplication.translate("dlgGetRunInfo", "Details for simulation run", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_5.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "Run id:", None, QtWidgets.QApplication.UnicodeUTF8))
        self.lblRunId.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "...", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_4.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "Scenario:", None, QtWidgets.QApplication.UnicodeUTF8))
        self.lblScenario_name.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "...", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "Run name:", None, QtWidgets.QApplication.UnicodeUTF8))
        self.lblRun_name.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "...", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_2.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "Years run:", None, QtWidgets.QApplication.UnicodeUTF8))
        self.lblYears_run.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "...", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_3.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "Cache directory:", None, QtWidgets.QApplication.UnicodeUTF8))
        self.lblCache_directory.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "...", None, QtWidgets.QApplication.UnicodeUTF8))
        self.tb_select_cachedir.setText(QtWidgets.QApplication.translate("dlgGetRunInfo", "...", None, QtWidgets.QApplication.UnicodeUTF8))
