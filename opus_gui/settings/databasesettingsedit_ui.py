...
#
# Created: Fri Aug 29 21:23:50 2008
...
class Ui_DatabaseSettingsEditGui(object):
    def setupUi(self, DatabaseSettingsEditGui):
        ...
        DatabaseSettingsEditGui.resize(QtCore.QSize(QtCore.QRect(0,0,576,730).size()).expandedTo(DatabaseSettingsEditGui.minimumSizeHint()))
