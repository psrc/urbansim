...
class Ui_XML_Editor(object):
    def setupUi(self, XML_Editor):
        ...
        XML_Editor.setWindowTitle(QtWidgets.QApplication.translate("XML_Editor", "XML Editor", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.revertButton.setText(QtWidgets.QApplication.translate("XML_Editor", "Revert", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.syntaxButton.setText(QtWidgets.QApplication.translate("XML_Editor", "Syntax Check", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.cancelButton.setText(QtWidgets.QApplication.translate("XML_Editor", "Cancel", None, QtWidgets.QApplication.UnicodeUTF8))
        self.cancelButton.setObjectName(_fromUtf8("cancelButton"))
        self.horizontalLayout.addWidget(self.cancelButton)
        self.okButton = QtWidgets.QPushButton(XML_Editor)
        self.okButton.setText(QtWidgets.QApplication.translate("XML_Editor", "OK", None, QtWidgets.QApplication.UnicodeUTF8))
