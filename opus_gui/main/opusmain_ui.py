...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.datamanager_xmlconfig.setGeometry(QtCore.QRect(0,0,352,450))
        ...
        self.gridlayout8 = QtGui.QGridLayout(self.tab_mapView)
        ...
        self.gridlayout8.addWidget(self.widgetMap,0,0,1,1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dataManager_toolBox.setItemText(self.dataManager_toolBox.indexOf(self.datamanager_xmlconfig), QtGui.QApplication.translate("MainWindow", "XML Config", None, QtGui.QApplication.UnicodeUTF8))
