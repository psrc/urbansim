...
class Ui_PreferencesDialog(object):
    ...
    def retranslateUi(self, PreferencesDialog):
        PreferencesDialog.setWindowTitle(QtWidgets.QApplication.translate("PreferencesDialog", "Preferences", None))
        self.fontGroupBox.setTitle(QtWidgets.QApplication.translate("PreferencesDialog", "Font Preferences", None))
        self.menuFontSizeLabel.setText(QtWidgets.QApplication.translate("PreferencesDialog", "Menu Bar Font Size", None))
        self.mainTabsFontSizeLabel.setText(QtWidgets.QApplication.translate("PreferencesDialog", "Main Tab Font Size", None))
        self.label.setText(QtWidgets.QApplication.translate("PreferencesDialog", "General Text Font Size", None))
        self.prevProjPrefGroupBox.setTitle(QtWidgets.QApplication.translate("PreferencesDialog", "Previous Project Preferences", None))
        self.prevProjPrefCheckBox.setText(QtWidgets.QApplication.translate("PreferencesDialog", "Open previous project on startup", None))
        self.prevProjPrefTabCheckBox.setText(QtWidgets.QApplication.translate("PreferencesDialog", "Activate previous tab on startup", None))
        self.applyButton.setText(QtWidgets.QApplication.translate("PreferencesDialog", "Apply", None))
        self.okButton.setText(QtWidgets.QApplication.translate("PreferencesDialog", "OK", None))
        self.cancelButton.setText(QtWidgets.QApplication.translate("PreferencesDialog", "Cancel", None))
