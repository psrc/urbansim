...
# Form implementation generated from reading ui file '/Users/ckla/Documents/workspace/variable_library_rewrite/opus_gui/main/views/mainwindow.ui'
#
# Created: Wed Apr 22 22:06:21 2009
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/Images/Images/script_save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/Images/Images/help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actAbout.setIcon(icon12)
        self.actAbout.setObjectName("actAbout")
        self.tabActionEditor = QtGui.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/Images/Images/table.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabActionEditor.setIcon(icon13)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/Images/Images/python_type.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabActionPythonConsole.setIcon(icon15)
        ...
        self.actPythonView.setIcon(icon15)
        ...
        self.actLogView.setIcon(icon13)
        self.actLogView.setObjectName("actLogView")
        self.actEditorView = QtGui.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/Images/Images/table_lightning.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actEditorView.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/Images/Images/close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actCloseProject.setIcon(icon17)
        self.actCloseProject.setObjectName("actCloseProject")
        self.actVariableLibrary = QtGui.QAction(MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/Images/Images/variable_library.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actVariableLibrary.setIcon(icon18)
        self.actVariableLibrary.setObjectName("actVariableLibrary")
        self.actPreferences = QtGui.QAction(MainWindow)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/Images/Images/configure.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actPreferences.setIcon(icon19)
        self.actPreferences.setObjectName("actPreferences")
        self.actLaunchResultBrowser = QtGui.QAction(MainWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/Images/Images/result_browser.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actLaunchResultBrowser.setIcon(icon20)
        self.actLaunchResultBrowser.setObjectName("actLaunchResultBrowser")
        self.actDatabaseSettings = QtGui.QAction(MainWindow)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/Images/Images/database_link.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actDatabaseSettings.setIcon(icon21)
