...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.generalmanager_page.setGeometry(QtCore.QRect(0, 0, 402, 372))
        ...
        self.datamanager_page.setGeometry(QtCore.QRect(0, 0, 402, 372))
        ...
        self.datamanager_xmlconfig.setGeometry(QtCore.QRect(0, 0, 372, 325))
        ...
        self.modelmanager_page.setGeometry(QtCore.QRect(0, 0, 402, 372))
        ...
        self.runmanager_page.setGeometry(QtCore.QRect(0, 0, 402, 372))
        ...
        self.resultsmanager_page.setGeometry(QtCore.QRect(0, 0, 402, 372))
        ...
        self.tab_editorView.setGeometry(QtCore.QRect(0, 0, 357, 372))
        ...
        self.tab_pythonView.setGeometry(QtCore.QRect(0, 0, 357, 372))
        ...
        self.tab_logView.setGeometry(QtCore.QRect(0, 0, 357, 372))
        ...
        self.actionOpen_Project_2.setIcon(icon11)
        ...
        self.actionEdit_all_variables.setIcon(icon16)
        ...
        self.actionDatabaseSettings.setIcon(icon19)
        ...
        self.toolBar.addAction(self.actionOpen_Project_2)
        self.toolBar.addAction(self.actionSave_Project_2)
        self.toolBar.addAction(self.actionClose_Project)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.actionEdit_all_variables)
        self.toolBar.addAction(self.actLaunchResultBrowser)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.actionPython_View)
        self.toolBar.addAction(self.actionLog_View)
        self.toolBar.addAction(self.actionEditor_View)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.actionDatabaseSettings)
        self.toolBar.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionPython_View.setToolTip(QtGui.QApplication.translate("MainWindow", "Open Python Console", None, QtGui.QApplication.UnicodeUTF8))
        self.actionLog_View.setText(QtGui.QApplication.translate("MainWindow", "Log View", None, QtGui.QApplication.UnicodeUTF8))
        self.actionLog_View.setToolTip(QtGui.QApplication.translate("MainWindow", "Open Log View", None, QtGui.QApplication.UnicodeUTF8))
        self.actionEditor_View.setText(QtGui.QApplication.translate("MainWindow", "Editor View", None, QtGui.QApplication.UnicodeUTF8))
        self.actionEditor_View.setToolTip(QtGui.QApplication.translate("MainWindow", "Open Editor View", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionClose_Project.setToolTip(QtGui.QApplication.translate("MainWindow", "Close Project", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionEdit_all_variables.setToolTip(QtGui.QApplication.translate("MainWindow", "Open Variable Library", None, QtGui.QApplication.UnicodeUTF8))
        self.actionPreferences.setText(QtGui.QApplication.translate("MainWindow", "Preferences", None, QtGui.QApplication.UnicodeUTF8))
        self.actionPreferences.setToolTip(QtGui.QApplication.translate("MainWindow", "Open Preferences", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionDatabaseSettings.setToolTip(QtGui.QApplication.translate("MainWindow", "Open Database Connection Settings", None, QtGui.QApplication.UnicodeUTF8))
