...
class ChoiceModelFromTemplateDialog(ModelFromTemplateDialogBase):
    ...
    def setup_node(self):
        ...
        self.set_structure_element_to_value('init/choice_set', self.leChoiceSet.text())
        self.set_structure_element_to_value('init/submodel_string', self.leSubModelString.text())
        self.set_structure_element_to_value('init/choice_attribute_name', self.leChoiceAttributeName.text())
        self.set_structure_element_to_value('init/estimate_config/estimation_size_agents', self.leEstimationSizeAgents.text())
        self.set_structure_element_to_value('run/agent_set', agent_set)
        self.set_structure_element_to_value('prepare_for_run/agent_set', agent_set)
        ...
        self.set_structure_element_to_value('prepare_for_estimate/agent_filter', agent_set_filter)
