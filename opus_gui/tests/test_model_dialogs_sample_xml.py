...
<model_system>
      ...
      <simple_model_template copyable="True" type="dictionary" >
        ...
        <init type="dictionary" >
          <name hidden="True" type="string" >SimpleModel</name>
        </init>
        <run type="dictionary" >
      ...
      <choice_model_template copyable="True" type="dictionary" >
        ...
        <init type="dictionary" >
          <name hidden="True" type="string" >ChoiceModel</name>
          <arguments type="dictionary" >
        ...
        <run type="dictionary" >
          <arguments type="dictionary" >
            ...
            <agents_index hidden="True" type="string" >cm_index</agents_index>
        ...
        <prepare_for_run type="dictionary" >
          ...
          <arguments type="dictionary" >
            ...
            <cache_storage hidden="True" type="string" >base_cache_storage</cache_storage>
            <multiplicator type="integer" >1</multiplicator>
          </arguments>
          <output hidden="True" type="string" >(specification, coefficients, cm_index)</output>
        </prepare_for_run>
        ...
        <prepare_for_estimate type="dictionary" >
          ...
          <output hidden="True" type="string" >(specification, cm_index)</output>
      ...
      <regression_model_template copyable="True" type="dictionary" >
        ...
        <init type="dictionary" >
          <name hidden="True" type="string" >RegressionModel</name>
          <arguments type="dictionary" >
        ...
        <prepare_for_estimate type="dictionary" >
          ...
          <output hidden="True" type="string" >(specification, rm_index)</output>
        </prepare_for_estimate>
      ...
      <allocation_model_template copyable="True" type="dictionary" >
        ...
        <init type="dictionary" >
          <name hidden="True" type="string" >AllocationModel</name>
        </init>
        <run type="dictionary" >
          <arguments type="dictionary" >
            <dataset type="string" >fill in</dataset>
            ...
            <control_totals hidden="True" type="string" >cts</control_totals>
            <current_year hidden="True" type="string" >year</current_year>
        ...
        <prepare_for_run type="dictionary" >
          ...
          <output hidden="True" type="string" >cts</output>
        </prepare_for_run>
      ...
      <agent_location_choice_model_template copyable="True" type="dictionary" >
        ...
        <init type="dictionary" >
          <name hidden="True" type="string" >AgentLocationChoiceModel</name>
          <arguments type="dictionary" >
        ...
        <prepare_for_estimate type="dictionary" >
          <name hidden="True" type="string" >prepare_for_estimate</name>
          <output hidden="True" type="string" >(alcm_specification, alcm_index)</output>
          <arguments type="dictionary" >
            <specification_storage type="string" >base_cache_storage</specification_storage>
            ...
            <data_objects hidden="True" type="string" >datasets</data_objects>
            <index_to_unplace hidden="True" parser_action="blank_to_None" type="string" />
            <join_datasets type="boolean" choices="True|False" >True</join_datasets>
            <portion_to_unplace hidden="True" type="string" >1.0</portion_to_unplace>
            <filter parser_action="blank_to_None" type="quoted_string" />
            <location_id_variable parser_action="blank_to_None" type="quoted_string" />
          </arguments>
        </prepare_for_estimate>
        <estimate type="dictionary" >
          <output hidden="True" type="string" >(alcm_coefficients, dummy)</output>
          <arguments type="dictionary" >
            <agent_set type="string" >fill in</agent_set>
            <agents_index hidden="True" type="string" >alcm_index</agents_index>
            <procedure type="quoted_string" >opus_core.bhhh_mnl_estimation</procedure>
            <data_objects hidden="True" type="string" >datasets</data_objects>
            <debuglevel hidden="True" type="string" >debuglevel</debuglevel>
            <specification hidden="True" type="string" >alcm_specification</specification>
          </arguments>
        </estimate>
        <prepare_for_run type="dictionary" >
          <name hidden="True" type="string" >prepare_for_run</name>
          <output hidden="True" type="string" >(alcm_specification, alcm_coefficients)</output>
          <arguments type="dictionary" >
            <coefficients_storage type="string" >base_cache_storage</coefficients_storage>
        ...
        <run type="dictionary" >
          <arguments type="dictionary" >
            <agent_set type="string" >fill in</agent_set>
            <agents_index hidden="True" parser_action="blank_to_None" type="string" />
            <chunk_specification type="string" >{'records_per_chunk':50000}</chunk_specification>
            <coefficients hidden="True" type="string" >alcm_coefficients</coefficients>
            <data_objects hidden="True" type="string" >datasets</data_objects>
            <debuglevel hidden="True" type="string" >debuglevel</debuglevel>
            <specification hidden="True" type="string" >alcm_specification</specification>
