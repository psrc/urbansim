...
#
# Created: Wed Sep 10 12:43:40 2008
...
class Ui_ExecuteToolSetGui(object):
    def setupUi(self, ExecuteToolSetGui):
        ...
        self.gridlayout1.addWidget(self.execTool,0,1,1,1)
    ...
    def retranslateUi(self, ExecuteToolSetGui):
        ...
        self.execTool.setText(QtGui.QApplication.translate("ExecuteToolSetGui", "Execute Tool Set", None, QtGui.QApplication.UnicodeUTF8))
