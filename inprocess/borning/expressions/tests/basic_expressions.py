...
class Tests(opus_unittest.OpusTestCase):
    ...
    # this test doesn't work with the old compiler either!
    ...
    def skip_test_fully_qualified_name_power(self):
    ...
    def skip_test_two_expressions(self):
    ...
    def skip_test_expression_2vars(self):
    ...
    def skip_test_expression_1var_2times(self):
    ...
    def skip_test_sqrt_constant(self):
    ...
    def skip_test_numpy_arange_constant(self):
    ...
    def skip_test_numpy_arange_constant2(self):
