...
if __name__ == "__main__":
    ...
    pardir = "/Users/hana/workspace/data/psrc_parcel/runs/bmanal/run213_val2010_%s" % validation_geography
    output_directory = "/Users/hana/workspace/data/psrc_parcel/runs/bmanal/run%s_quantiles_%s" % (run, validation_geography)
    ...
    export_quantiles(bmf, output_directory, years=[2020, 2025, 2030, 2035, 2040], validation_geography=validation_geography,
