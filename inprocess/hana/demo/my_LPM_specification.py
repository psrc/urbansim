...
[
 ('constant', 'constant'),
 ('urbansim.gridcell.percent_developed_within_walking_distance', 'PCTDEVWAL'),
 ...
 ('ln(urbansim.gridcell.total_improvement_value)', 'LN_IMPVAL'),
 ('eugene.gridcell.travel_time_hbw_am_drive_alone_to_220', 'CBDTRVL'),
 ...
 ('urbansim.gridcell.population', 'POP'),
 
 #('urbansim.gridcell.percent_residential', 'PCT_RES'),
