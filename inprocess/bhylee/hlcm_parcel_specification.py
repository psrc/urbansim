...
#             "B_percent_home_renter_households_within_walking_distance = building.disaggregate(psrc.parcel.percent_home_renters_within_walking_distance)",
...
#             "C_has_children_x_ln_sqft_per_unit = (household.children > 0) * ln(psrc_parcel.building.sqft_per_unit)",
             "C_has_children_x_percent_households_with_children_within_walking_distance = (household.children > 0) * building.disaggregate(psrc.parcel.percent_households_with_children_within_walking_distance)",
...
#             "C_is_high_income_x_percent_home_owner_households_within_walking_distance = urbansim.household.is_high_income * building.disaggregate(psrc.parcel.percent_home_owners_within_walking_distance)",
#             "C_is_high_income_x_percent_home_renter_households_within_walking_distance = urbansim.household.is_high_income * building.disaggregate(psrc.parcel.percent_home_renters_within_walking_distance)",
...
#             "C_is_home_owner_x_percent_home_owner_households_within_walking_distance = (household.tenure < 3) * building.disaggregate(psrc.parcel.percent_home_owners_within_walking_distance)",
...
#             "C_is_young_x_percent_home_renter_households_within_walking_distance = urbansim.household.is_young * building.disaggregate(psrc.parcel.percent_home_renters_within_walking_distance)",
...
#             "C_ln_income_x_percent_home_owner_households_within_walking_distance = ln(household.income) * building.disaggregate(psrc.parcel.percent_home_owners_within_walking_distance)",
