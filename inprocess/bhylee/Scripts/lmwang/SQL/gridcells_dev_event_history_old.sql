...
--<deh_btemp_sqft_units_by_parcel_year_use>
set @step = '2b';
set @work = 'deh_btemp_sqft_units_by_parcel_year_use';
select @step as STEP, @work as NOW_WORKING;

drop table if exists deh_btemp_sqft_units_by_parcel_year_use;
...
;
--## create deh_btemp_sqft_units_by_parcel_year_use table by
--## extracting seperately from PSRC_parcels_`county` tables
-- create table
-- 	deh_btemp_sqft_units_by_parcel_year_use
-- select
-- 	p.PARCEL_ID,
...
alter table deh_btemp_sqft_units_by_parcel_year_use
add RESIDENTIAL_SQFT int,
add COMMERCIAL_SQFT int,
add INDUSTRIAL_SQFT int,
add GOVERNMENTAL_SQFT int
;

update deh_btemp_sqft_units_by_parcel_year_use
...
create index
	deh_btemp_sqft_units_by_parcel_year_use_parcel_id_county_index
on
	deh_btemp_sqft_units_by_parcel_year_use
...
from deh_btemp_sqft_units_by_parcel_year_use
where BUILDING_USE = 'R'
group by 
	PARCEL_ID, 
	COUNTY
...
update 
	deh_btemp_sqft_units_by_parcel_year_use t, btemp_table_r r
...
update 
	deh_btemp_sqft_units_by_parcel_year_use t, btemp_table_c c
...
update 
	deh_btemp_sqft_units_by_parcel_year_use t, btemp_table_i i
...
update 
	deh_btemp_sqft_units_by_parcel_year_use t, btemp_table_g g
...
set @step = '2f';
set @work = 'deh_ctemp_sqft_units_impv_by_parcel_year_use';
select @step as STEP, @work as NOW_WORKING;

drop table if exists deh_ctemp_sqft_units_impv_by_parcel_year_use;
create table
	deh_ctemp_sqft_units_impv_by_parcel_year_use
select
	b.*,
	p.RESIDENTIAL_UNITS as TOTAL_RES_UNITS_IN_PARCEL,
	p.IMPROVEMENT_VALUE as TOTAL_IMPV_IN_PARCEL,
	p.RESIDENTIAL_IMPROVEMENT_VALUE as TOTAL_RES_IMPV_IN_PARCEL,
	p.COMMERCIAL_IMPROVEMENT_VALUE as TOTAL_COM_IMPV_IN_PARCEL,
	p.INDUSTRIAL_IMPROVEMENT_VALUE as TOTAL_IND_IMPV_IN_PARCEL,
	p.GOVERNMENTAL_IMPROVEMENT_VALUE as TOTAL_GOV_IMPV_IN_PARCEL
from 	
	deh_btemp_sqft_units_by_parcel_year_use b
	  inner join deh_ptemp_units_impv_by_parcel p
	  on b.PARCEL_ID = p.PARCEL_ID
	  and b.COUNTY = p.COUNTY
;

create index deh_ctemp_sqft_units_impv_by_parcel_year_use_index
on deh_ctemp_sqft_units_impv_by_parcel_year_use (PARCEL_ID,COUNTY,YEAR_BUILT);

alter table deh_ctemp_sqft_units_impv_by_parcel_year_use
add RESIDENTIAL_UNITS float,
...
--<deh_ptemp_avg_impv_by_county>
set @step = '2e';
set @work = 'deh_ptemp_avg_impv_by_county';
select @step as STEP, @work as NOW_WORKING;

create temporary table ctemp_sqft_by_year_parcel
select
	parcel_id,
	county,
	year_built,
...
create temporary table ctemp_units_by_year_parcel
select 
	parcel_id,
	county,
	year_built,
...
update ctemp_sqft_by_year_parcel s
	inner join 
	  on   s.parcel_id = u.parcel_id
	   and s.county = u.county
	   and s.year_built = u.year_built
set s.residential_units = u.residential_units
;

drop table if exists deh_ptemp_avg_impv_by_county;
create table deh_ptemp_avg_impv_by_county
select
	county, 
	sum(RESIDENTIAL_IMPROVEMENT_VALUE) as TOTAL_RES_IMPV,
	sum(COMMERCIAL_IMPROVEMENT_VALUE) as TOTAL_COM_IMPV,
	sum(INDUSTRIAL_IMPROVEMENT_VALUE) as TOTAL_IND_IMPV,
	sum(GOVERNMENTAL_IMPROVEMENT_VALUE) as TOTAL_GOV_IMPV,
	0 as TOTAL_RES_SQFT,
	0 as TOTAL_COM_SQFT,
	0 as TOTAL_IND_SQFT,
	0 as TOTAL_GOV_SQFT,
	...
	0 as AVG_IND_IMPV,
	0 as AVG_GOV_IMPV
from deh_ptemp_units_impv_by_parcel 
	inner join btemp_table_r
...
create temporary table btemp_total_sqft_by_county
select 
	county, 
	sum(RESIDENTIAL_SQFT) as TOTAL_RES_SQFT,
	sum(COMMERCIAL_SQFT) as TOTAL_COM_SQFT,
	sum(INDUSTRIAL_SQFT) as TOTAL_IND_SQFT,
	sum(GOVERNMENTAL_SQFT) as TOTAL_GOV_SQFT
from deh_btemp_sqft_units_by_parcel_year_use su
where 
  county in ('033','053','061')
  and year_built = 2000
group by county;

insert into btemp_total_sqft_by_county
select 
	county, 
	sum(RESIDENTIAL_SQFT) as TOTAL_RES_SQFT,
	sum(COMMERCIAL_SQFT) as TOTAL_COM_SQFT,
...
update deh_ptemp_avg_impv_by_county aiv, btemp_total_sqft_by_county ts
set 
	aiv.TOTAL_RES_SQFT = ts.TOTAL_RES_SQFT,
	aiv.TOTAL_COM_SQFT = ts.TOTAL_COM_SQFT,
	aiv.TOTAL_IND_SQFT = ts.TOTAL_IND_SQFT,
	aiv.TOTAL_GOV_SQFT = ts.TOTAL_GOV_SQFT
where aiv.county = ts.county;

update deh_ptemp_avg_impv_by_county 
set 
	AVG_RES_IMPV = TOTAL_RES_IMPV / TOTAL_RES_SQFT,
...
update
	deh_ctemp_sqft_units_impv_by_parcel_year_use s, deh_ptemp_avg_impv_by_county a
set s.RESIDENTIAL_IMPROVEMENT_VALUE = s.RESIDENTIAL_SQFT * a.AVG_RES_IMPV,
    s.COMMERCIAL_IMPROVEMENT_VALUE = s.COMMERCIAL_SQFT * a.AVG_COM_IMPV,
    s.INDUSTRIAL_IMPROVEMENT_VALUE = s.INDUSTRIAL_SQFT * a.AVG_IND_IMPV,
    s.GOVERNMENTAL_IMPROVEMENT_VALUE = s.GOVERNMENTAL_SQFT * a.AVG_GOV_IMPV
where
	s.county = a.county
;
...
-- select 'D' as STEP, 'Diagnosing...' as NOW_WORKING;

-- select 
-- 	sum(NUM_BUILDINGS) as TOTAL_RES_BUILDINGS, 
-- 	sum(BUILT_SQFT) as TOTAL_RES_BUILT_SQFT 
-- from deh_btemp_sqft_units_by_parcel_year_use 
-- 	where building_use = 'R';

-- select 
-- 	sum(NUM_BUILDINGS) as TOTAL_COM_BUILDINGS, 
-- 	sum(BUILT_SQFT) as TOTAL_COM_BUILT_SQFT 
-- from deh_btemp_sqft_units_by_parcel_year_use 
-- 	where building_use = 'C';

-- select 
-- 	sum(NUM_BUILDINGS) as TOTAL_IND_BUILDINGS, 
-- 	sum(BUILT_SQFT) as TOTAL_IND_BUILT_SQFT 
-- from deh_btemp_sqft_units_by_parcel_year_use 
-- 	where building_use = 'I';

-- select 
-- 	sum(NUM_BUILDINGS) as TOTAL_GOV_BUILDINGS, 
-- 	sum(BUILT_SQFT) as TOTAL_GOV_BUILT_SQFT 
-- from deh_btemp_sqft_units_by_parcel_year_use 
-- 	where building_use = 'G';

-- select 
-- 	sum(TOTAL_RES_BUILDINGS_IN_PARCEL), 
-- 	sum(TOTAL_RES_SQFT_IN_PARCEL) 
-- from deh_btemp_sqft_units_by_parcel_year_use;

-- select 
-- 	sum(TOTAL_COM_BUILDINGS_IN_PARCEL), 
-- 	sum(TOTAL_COM_SQFT_IN_PARCEL) 
-- from deh_btemp_sqft_units_by_parcel_year_use;

-- select 
-- 	sum(TOTAL_IND_BUILDINGS_IN_PARCEL), 
-- 	sum(TOTAL_IND_SQFT_IN_PARCEL) 
-- from deh_btemp_sqft_units_by_parcel_year_use;

-- select 
-- 	sum(TOTAL_GOV_BUILDINGS_IN_PARCEL), 
-- 	sum(TOTAL_GOV_SQFT_IN_PARCEL) 
-- from deh_btemp_sqft_units_by_parcel_year_use;

-- select 
-- 	sum(p.RESIDENTIAL_UNITS) as missing_residential_units, 
-- 	sum(p.IMPROVEMENT_VALUE) as missing_improvement_value
-- from deh_ptemp_units_impv_by_parcel p
-- 	left outer join deh_btemp_sqft_units_by_parcel_year_use y
-- 	on p.PARCEL_ID = y.PARCEL_ID
-- 	and p.COUNTY = y.COUNTY
-- where y.PARCEL_ID is null;

-- create temporary table temp_unassigned_units
-- select 
-- 	parcel_id,avg(TOTAL_RES_UNITS_IN_PARCEL) as unassigned_units
-- from deh_ctemp_sqft_units_impv_by_parcel_year_use 
-- where 
-- 	(TOTAL_RES_BUILDINGS_IN_PARCEL = 0 or TOTAL_RES_BUILDINGS_IN_PARCEL is null) 
-- 	and TOTAL_RES_UNITS_IN_PARCEL > 0
-- 	and COUNTY in ('035','053','061')
-- group by parcel_id
-- ;

-- select sum(unassigned_units) from temp_unassigned_units;
-- #17310, this 17310 units appear in parcels table but there are no residential buildings 
-- #in this parcels as shown in buildings table

---# the closer, the better #---
-- select sum(RESIDENTIAL_UNITS), sum(IMPROVEMENT_VALUE) from deh_ptemp_units_impv_by_parcel;
-- select sum(RESIDENTIAL_UNITS) from deh_ctemp_sqft_units_impv_by_parcel_year_use;

-- select sum(IMPROVEMENT_VALUE) from deh_ptemp_units_impv_by_parcel;
-- select sum(ifnull(RESIDENTIAL_IMPROVEMENT_VALUE,0)+ifnull(COMMERCIAL_IMPROVEMENT_VALUE,0)
--   +ifnull(INDUSTRIAL_IMPROVEMENT_VALUE,0)+ifnull(GOVERNMENTAL_IMPROVEMENT_VALUE,0)) 
--   from deh_ctemp_sqft_units_impv_by_parcel_year_use where YEAR_BUILT = 2000;

-- select sum(RESIDENTIAL_UNITS), sum(TOTAL_RES_UNITS_IN_PARCEL), sum(TOTAL_IMPV_IN_PARCEL) 
--       from deh_ctemp_sqft_units_impv_by_parcel_year_use;
---- */ \end diagnostic code;


-- step 2g
--<deh_temp_sqft_units_impv_by_parcel_year>
set @step = '2g';
set @work = 'deh_temp_sqft_units_impv_by_parcel_year';
select @step as STEP, @work as NOW_WORKING;

drop table if exists deh_temp_sqft_units_impv_by_parcel_year;
create table deh_temp_sqft_units_impv_by_parcel_year
select 
	PARCEL_ID,
	COUNTY,
	YEAR_BUILT,
...
select
	...
	p.COUNTY
from
	deh_temp_sqft_units_impv_by_parcel_year p
	  inner join
...
create index 
	deh_temp_gridcells_added_grid_id_year_built_index
on
	deh_temp_gridcells_added_w_pid
...
-- a trick for handling NULL year_built, set NULL = 0, and change back later.
update deh_temp_gridcells_added_by_grid_id_year
set YEAR_BUILT = 0
where YEAR_BUILT is null
;

create index deh_temp_gridcells_added_by_grid_id_year_index
...
-- step 3d. compound yearly added built_sqft and residential_units into 
-- total built_sqft and residential_units in a gridcell
--<deh_temp_gridcells_sum_by_grid_id_year>
-- #we didn't use this any more, instead we roll back from baseyear gridcells
-- as the EDW did
-- set @step = '3d';
-- set @work = 'deh_temp_gridcells_sum_by_grid_id_year';
-- select @step as STEP, @work as NOW_WORKING;

-- drop table if exists deh_temp_gridcells_sum_by_grid_id_year;
-- create table deh_temp_gridcells_sum_by_grid_id_year (
-- GRID_ID int,
-- YEAR_BUILT int,
-- COMMERCIAL_SQFT int,
...
-- insert into deh_temp_gridcells_sum_by_grid_id_year
-- 	(GRID_ID, YEAR_BUILT, COMMERCIAL_SQFT, COMMERCIAL_IMPROVEMENT_VALUE, 
-- 	INDUSTRIAL_SQFT, INDUSTRIAL_IMPROVEMENT_VALUE, GOVERNMENTAL_SQFT, 
-- 	GOVERNMENTAL_IMPROVEMENT_VALUE, RESIDENTIAL_UNITS, RESIDENTIAL_IMPROVEMENT_VALUE)
-- select
...
-- 	sum(g2.COMMERCIAL_IMPROVEMENT_VALUE) as COMMERCIAL_IMPROVEMENT_VALUE,
-- 	sum(g2.INDUSTRIAL_SQFT) as INDUSTRIAL_SQFT,
-- 	sum(g2.INDUSTRIAL_IMPROVEMENT_VALUE) as INDUSTRIAL_IMPROVEMENT_VALUE,
-- 	sum(g2.GOVERNMENTAL_SQFT) as GOVERNMENTAL_SQFT,
-- 	sum(g2.GOVERNMENTAL_IMPROVEMENT_VALUE) as GOVERNMENTAL_IMPROVEMENT_VALUE,
-- 	sum(g2.RESIDENTIAL_UNITS) as RESIDENTIAL_UNITS,
-- 	sum(g2.RESIDENTIAL_IMPROVEMENT_VALUE) RESIDENTIAL_IMPROVEMENT_VALUE
-- from
...
-- -- 1284202
-- update deh_temp_gridcells_sum_by_grid_id_year
...
-- create index deh_temp_gridcells_sum_by_grid_id_year_grid_id_index
-- on deh_temp_gridcells_sum_by_grid_id_year (GRID_ID,YEAR_BUILT);
...
-- on deh_temp_gridcells_sum_by_grid_id_year (TOTAL_NONRES_SQFT, RESIDENTIAL_UNITS);
--</deh_temp_gridcells_sum_by_grid_id_year >


-- step 3d.1 compound yearly added built_sqft and residential_units into 
-- total built_sqft and residential_units in a gridcell
...
-- step 3d.2 create historical gridcells table
...
select
	...
	(g1.COMMERCIAL_IMPROVEMENT_VALUE - g2.COMMERCIAL_IMPROVEMENT_VALUE) as COMMERCIAL_IMPROVEMENT_VALUE,
	(g1.INDUSTRIAL_SQFT - g2.INDUSTRIAL_SQFT) as INDUSTRIAL_SQFT,
	(g1.INDUSTRIAL_IMPROVEMENT_VALUE - g2.INDUSTRIAL_IMPROVEMENT_VALUE) as INDUSTRIAL_IMPROVEMENT_VALUE,
	(g1.GOVERNMENTAL_SQFT - g2.GOVERNMENTAL_SQFT) as GOVERNMENTAL_SQFT,
	(g1.GOVERNMENTAL_IMPROVEMENT_VALUE - g2.GOVERNMENTAL_IMPROVEMENT_VALUE) as GOVERNMENTAL_IMPROVEMENT_VALUE,
	(g1.RESIDENTIAL_UNITS - g2.RESIDENTIAL_UNITS) as RESIDENTIAL_UNITS,
	(g1.RESIDENTIAL_IMPROVEMENT_VALUE - g2.RESIDENTIAL_IMPROVEMENT_VALUE) RESIDENTIAL_IMPROVEMENT_VALUE
from
...
insert into deh_temp_gridcells_by_grid_id_year
	(GRID_ID, YEAR_BUILT, COMMERCIAL_SQFT, COMMERCIAL_IMPROVEMENT_VALUE, 
	INDUSTRIAL_SQFT, INDUSTRIAL_IMPROVEMENT_VALUE, GOVERNMENTAL_SQFT, 
	GOVERNMENTAL_IMPROVEMENT_VALUE, RESIDENTIAL_UNITS, RESIDENTIAL_IMPROVEMENT_VALUE, DEVELOPMENT_TYPE_ID)
select
	distinct g1.GRID_ID,
	2001 as YEAR_BUILT,
	g1.COMMERCIAL_SQFT,
	g1.COMMERCIAL_IMPROVEMENT_VALUE,
	g1.INDUSTRIAL_SQFT,
	g1.INDUSTRIAL_IMPROVEMENT_VALUE,
	g1.GOVERNMENTAL_SQFT,
	g1.GOVERNMENTAL_IMPROVEMENT_VALUE,
	g1.RESIDENTIAL_UNITS,
	g1.RESIDENTIAL_IMPROVEMENT_VALUE,
...
---- clear development_event_history table
...
---- create transition_types before running script below

update development_event_history
set COMMERCIAL_IMPROVEMENT_VALUE = COMMERCIAL_IMPROVEMENT_VALUE / COMMERCIAL_SQFT,
INDUSTRIAL_IMPROVEMENT_VALUE = INDUSTRIAL_IMPROVEMENT_VALUE / INDUSTRIAL_SQFT,
GOVERNMENTAL_IMPROVEMENT_VALUE = GOVERNMENTAL_IMPROVEMENT_VALUE / GOVERNMENTAL_SQFT
--,RESIDENTIAL_IMPROVEMENT_VALUE = RESIDENTIAL_IMPROVEMENT_VALUE / RESIDENTIAL_UNITS
;
...
-- drop table deh_btemp_sqft_units_by_parcel_year_use;
