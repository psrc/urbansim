...
my $mysql_output_db='Eugene1980_output_1125'; 
my $mysql_user='urbansim';
my $mysql_passwd='UwUrbAnsIm';
my $mysql_frac_table;#='temp_GridCellFractionsInZones';
my $mysql_gridcell;#='temp_GridCells';
my $mysql_changes_table;#='JobsChanges';
my $id;#='JOB_ID';
my $mysql_zone_table;#='JobsByZone';
...
print LOG "end time: $hour:$min:$sec.\n";
