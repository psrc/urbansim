...
# make all Education K-12 jobs -> Education K-12
update jobs_with_copy_status
set new_sector_id = 16 where sector_id = 3;

# make all Federal, Civilian jobs -> Federal, Civilian
update jobs_with_copy_status
set new_sector_id = 14 where sector_id = 4;

# make all FIRES jobs -> FIRES
update jobs_with_copy_status
set new_sector_id = 10 where sector_id = 6;

# make all manufacturing -> manufacturing -aviation 
#  where sic in (-9998) or 
update jobs_with_copy_status  
set new_sector_id = 3 where sic between 3720 and 3729 or sic between 3790 and 3799 or sic between 3740 and 3769
or sic between 3710 and 3719 or sic between -9998 and -9998;

#select count(*) from jobs_bak where sic between 3720 and 3729 or sic between 3790 and 3799 or sic between 3740 and 3769
#or sic between 3710 and 3719 or sic between -9998 and -9998;

#
update jobs_with_copy_status 
set new_sector_id = 4 where sic not between 3720 and 3729 and sic not between 3790 and 3799 and sic not between 3740 and 3769
and sic not between 3710 and 3719 and sic not between -9998 and -9998 and sector_id = 7;

#select count(*) from jobs_bak where sic not between 3720 and 3729 and sic not between 3790 and 3799 and sic not between 3740 and 3769
#and sic not between 3710 and 3719 and sic not between -9998 and -9998 and sector_id = 7;

update jobs_with_copy_status
set new_sector_id = 4 where sector_id = 7 and proprietor = 1;

#select count(*) from jobs_bak where sector_id = 7 and proprietor = 1;
...
# make all State and Local jobs -> State and Local
update jobs_with_copy_status
set new_sector_id = 18 where sector_id = 11;

# make all wholesale trade -> wholesale trade.
update jobs_with_copy_status
set new_sector_id = 7  where sector_id = 13;

# make all Education Higher jobs -> Education Higher
update jobs_with_copy_status 
set new_sector_id = 17 where sector_id = 14;
...
############# temp ###################
drop table if exists jobs_lost;
