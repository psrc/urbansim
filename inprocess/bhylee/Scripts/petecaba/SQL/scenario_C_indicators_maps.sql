...
# Change Scenario C 2030 - Baseline 2030 Households 
...
# Change Scenario C 2030 - Baseline 2030 Household Size
...
# Change Scenario C 2030 - Baseline 2030 Household Income
...
# Change Scenario C 2030 - Baseline 2030 Employment characteristics
...
CREATE TEMPORARY TABLE tmp_real_estate_inventory_2030
 ...
 INNER JOIN PSRC_2000_scenario_C_increased_environmental.gridcells b 
...
# Change Scenario C 2030 - Baseline 2030 units
...
# Change Scenario C 2030 - Baseline 2030 Nonresidential Sqft 
...
# Change Scenario C 2030 - Baseline 2030 Land Price 
...
# Scenario C 2030 Residential Vacancty Rate

UPDATE TAZ_INDICATORS SET RES_VAC_RATE_2030 = ROUND(1-(hh_2030/hh_units_2030),4);

# Change Scenario C 2030 - Baseline Vacancy Rate
...
# Change Scenario C 2030 - Baseline 2030 Logsum-weighted change in SOV accesibility
...
# Change Scenario C 2030 - Baseline 2030 Logsum-weighted change in TRANSIT accesibility
