...
CREATE TABLE TAZ_INDICATORS
 (ZONE_ID INT, 
  ...
  CH_AVG_HH_SZ_2000_BASE_2030 DOUBLE,
  AVG_HH_INC_2030 DOUBLE,
  CH_AVG_HH_INC_2000_BASE_2030 DOUBLE,
  JOBS_2030 INT,
  CH_JOBS_2000_BASE_2030 DOUBLE,
  HH_UNITS_2030 INT,
  CH_HU_2000_BASE_2030 DOUBLE,
  RES_VAC_RATE_2030 DOUBLE,
  CH_RES_VAC_RATE_2000_BASE_2030 DOUBLE,
  NONRES_SQFT_2030 INT,
  CH_NONRES_FLSP_2000_BASE_2030 DOUBLE,
  NONRES_VAC_RATE_2030 DOUBLE,
  CH_NONRES_VAC_RATE_2000_BASE_2030 DOUBLE,
  SOV_ACCESS_2030 DOUBLE,
  CH_SOV_ACCESS_2000_BASE_2030 DOUBLE,
  TRNST_ACCESS_2030 DOUBLE,
  CH_TRNST_ACCESS_2000_BASE_2030 DOUBLE,
  LP_2030 INT,
  CH_LP_2000_BASE_2030 DOUBLE);
...
UPDATE TAZ_INDICATORS a
 INNER JOIN PSRC_2000_base_run_2_output.TAZ_INDICATORS b
 ON a.ZONE_ID = b.ZONE_ID
SET a.CH_AVG_HH_SZ_2000_BASE_2030 = a.AVG_HH_SZ_2030 - b.AVG_HH_SZ_2030;
...
UPDATE TAZ_INDICATORS a
 INNER JOIN PSRC_2000_base_run_2_output.TAZ_INDICATORS b
 ON a.ZONE_ID = b.ZONE_ID
SET a.CH_AVG_HH_INC_2000_BASE_2030 = a.AVG_HH_INC_2030 - b.AVG_HH_INC_2030;
...
create temporary table jobs_2030 
 select * from jobs_exported_denormalized 
 where year = 2030
;

alter table jobs_2030 add index grid_id_index(grid_id);
...
UPDATE TAZ_INDICATORS a
 INNER JOIN PSRC_2000_base_run_2_output.TAZ_INDICATORS b 
 ON a.ZONE_ID = b.ZONE_ID 
 SET a.CH_JOBS_2000_BASE_2030 = a.JOBS_2030 - b.JOBS_2030;
...
UPDATE TAZ_INDICATORS a 
 INNER JOIN PSRC_2000_base_run_2_output.TAZ_INDICATORS b 
 ON a.ZONE_ID = b.ZONE_ID
SET a.CH_HU_2000_BASE_2030 = a.HH_UNITS_2030 - b.HH_UNITS_2030;
...
UPDATE TAZ_INDICATORS a
 INNER JOIN PSRC_2000_base_run_2_output.TAZ_INDICATORS b
 ON a.ZONE_ID = b.ZONE_ID 
SET a.CH_RES_VAC_RATE_2000_BASE_2030 = a.RES_VAC_RATE_2030 - b.RES_VAC_RATE_2030;
...
UPDATE TAZ_INDICATORS a
 INNER JOIN PSRC_2000_base_run_2_output.TAZ_INDICATORS b 
 ON a.ZONE_ID = b.ZONE_ID
SET a.CH_NONRES_FLSP_2000_BASE_2030 = a.NONRES_SQFT_2030 - b.NONRES_SQFT_2030;
...
UPDATE TAZ_INDICATORS a
 INNER JOIN PSRC_2000_base_run_2_output.TAZ_INDICATORS b
 ON a.ZONE_ID = b.ZONE_ID
SET a.CH_LP_2000_BASE_2030 = a.LP_2030 - b.LP_2030;
