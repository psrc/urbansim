...
# Select out the endyear (2003) data

drop table if exists households_exported_2003;
create table households_exported_2003
  select * 
  from households_exported 
  where year=2003;
create index hh 
  on households_exported_2003(household_id);

drop table if exists jobs_exported_2003;
create table jobs_exported_2003
  select * 
  from jobs_exported 
  where year=2003;
create index jobs 
  on jobs_exported_2003(job_id);

drop table if exists gridcells_exported_2003;
create table gridcells_exported_2003
  select * 
  from gridcells_exported 
  where year=2003;
create index grid 
  on gridcells_exported_2003(grid_id);

# Create a table that merges "constants" and "exported" data on households

drop table if exists households_all_2003;
create TABLE households_all_2003
  select households_exported_2003.grid_id, 
    households_exported_2003.zone_id, 
    households_constants.*
  from households_exported_2003, 
    households_constants
  where households_constants.household_id=households_exported_2003.household_id;
create index households_all_2003_household_id_zone_id 
  on households_all_2003 (household_id, zone_id);
...
alter table households_all_2000 add column(HH1 int(1)),
...
update households_all_2003 set HH1=1 where persons=1;
update households_all_2003 set HH2=1 where persons=2;
update households_all_2003 set HH3=1 where persons=3;
update households_all_2003 set HH4=1 where persons=4;
update households_all_2003 set HH5=.432 where persons=5;
update households_all_2003 set HH6P=.568 where persons=5;

# Set the top household size category to the representative "average" size for that category

update households_all_2003 set persons=5.8 where persons=5;
...
Create TEMPORARY TABLE tmp_gridcells_all
  select tmp_gridcell_zones.zone_id as zone_id, 
    gridcells_exported_2003.residential_units as residential_units
  from gridcells_exported_2003 inner join  
    tmp_gridcell_zones
  on gridcells_exported_2003.grid_id=tmp_gridcell_zones.grid_id;
...
Create TEMPORARY TABLE tmp_jobs_all
  select jobs_exported_2003.zone_id, 
    jobs_constants.*
  from jobs_exported_2003, 
    jobs_constants
  where jobs_constants.job_id=jobs_exported_2003.job_id;
...
Update households_all_2003 set S1ILW0=1 where persons=1 and income<20001 and workers=0;
Update households_all_2003 set S1ILW1=1 where persons=1 and income<20001 and workers=1;
Update households_all_2003 set S1ILW2=1 where persons=1 and income<20001 and workers=2;
Update households_all_2003 set S1ILW3=1 where persons=1 and income<20001 and workers=3;
Update households_all_2003 set S1IHW0=1 where persons=1 and income>20000 and workers=0;
Update households_all_2003 set S1IHW1=1 where persons=1 and income>20000 and workers=1;
Update households_all_2003 set S1IHW2=1 where persons=1 and income>20000 and workers=2;
Update households_all_2003 set S1IHW3=1 where persons=1 and income>20000 and workers=3;

Update households_all_2003 set S2ILW0=1 where persons=2 and income<20001 and workers=0;
Update households_all_2003 set S2ILW1=1 where persons=2 and income<20001 and workers=1;
Update households_all_2003 set S2ILW2=1 where persons=2 and income<20001 and workers=2;
Update households_all_2003 set S2ILW3=1 where persons=2 and income<20001 and workers=3;
Update households_all_2003 set S2IHW0=1 where persons=2 and income>20000 and workers=0;
Update households_all_2003 set S2IHW1=1 where persons=2 and income>20000 and workers=1;
Update households_all_2003 set S2IHW2=1 where persons=2 and income>20000 and workers=2;
Update households_all_2003 set S2IHW3=1 where persons=2 and income>20000 and workers=3;

Update households_all_2003 set S3ILW0=1 where persons=3 and income<20001 and workers=0;
Update households_all_2003 set S3ILW1=1 where persons=3 and income<20001 and workers=1;
Update households_all_2003 set S3ILW2=1 where persons=3 and income<20001 and workers=2;
Update households_all_2003 set S3ILW3=1 where persons=3 and income<20001 and workers=3;
Update households_all_2003 set S3IHW0=1 where persons=3 and income>20000 and workers=0;
Update households_all_2003 set S3IHW1=1 where persons=3 and income>20000 and workers=1;
Update households_all_2003 set S3IHW2=1 where persons=3 and income>20000 and workers=2;
Update households_all_2003 set S3IHW3=1 where persons=3 and income>20000 and workers=3;

Update households_all_2003 set S4ILW0=1 where persons=4 and income<20001 and workers=0;
Update households_all_2003 set S4ILW1=1 where persons=4 and income<20001 and workers=1;
Update households_all_2003 set S4ILW2=1 where persons=4 and income<20001 and workers=2;
Update households_all_2003 set S4ILW3=1 where persons=4 and income<20001 and workers=3;
Update households_all_2003 set S4IHW0=1 where persons=4 and income>20000 and workers=0;
Update households_all_2003 set S4IHW1=1 where persons=4 and income>20000 and workers=1;
Update households_all_2003 set S4IHW2=1 where persons=4 and income>20000 and workers=2;
Update households_all_2003 set S4IHW3=1 where persons=4 and income>20000 and workers=3;

Update households_all_2003 set S5ILW0=.432 where persons=5.8 and income<20001 and workers=0;
Update households_all_2003 set S5ILW1=.432 where persons=5.8 and income<20001 and workers=1;
Update households_all_2003 set S5ILW2=.432 where persons=5.8 and income<20001 and workers=2;
Update households_all_2003 set S5ILW3=.432 where persons=5.8 and income<20001 and workers=3;
Update households_all_2003 set S5IHW0=.432 where persons=5.8 and income>20000 and workers=0;
Update households_all_2003 set S5IHW1=.432 where persons=5.8 and income>20000 and workers=1;
Update households_all_2003 set S5IHW2=.432 where persons=5.8 and income>20000 and workers=2;
Update households_all_2003 set S5IHW3=.432 where persons=5.8 and income>20000 and workers=3;
