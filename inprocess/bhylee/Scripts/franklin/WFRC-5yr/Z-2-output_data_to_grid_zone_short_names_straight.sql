...
USE WFRC_1997_output_5yr_2003_straight;
...
UPDATE accessibilities_endyears
     SET year=1997
     WHERE year=1998;
...
CREATE TABLE zones_transpose 
 (zone_id int, dur_a int, iv_r_a double, 
  ...
  hae0_a double, hae1_a double, hae2_a double, hae3_a double, 
  hap0_a double, hap1_a double, hap2_a double, hap3_a double, 
  wae0_a double, wae1_a double, wae2_a double, wae3_a double, 
  wap0_a double, wap1_a double, wap2_a double, wap3_a double);

ALTER TABLE zones_transpose 
