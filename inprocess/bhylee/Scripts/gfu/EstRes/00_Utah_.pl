...
$Utah_app_dev=1;		# case Utah_app_dev
	$do_run += $Utah_app_dev;
$Utah_app_emp=0;		# case Utah_app_emp
	$do_run += $Utah_app_emp;
$Utah_app_hh=0;		# case Utah_app_hh
	$do_run += $Utah_app_hh;
$Utah_app_price=0;		# case Utah_app_price
	$do_run += $Utah_app_price;
...
# Case sections
if ($Utah_app_dev) {
	$path = "S:/urban-data/UrbanEst/Cities/Utah/App/dev";
	$setup = "setup_Utah_app_dev.dat";
	$fildir = "/dev";			# subdir prefix for individual models
	$filh = "/est19_Res";			# model output file prefix
...
if ($Utah_app_emp) {
	$path = "S:/urban-data/UrbanEst/Cities/Utah/App/emp";
	$setup = "setup_Utah_app_emp.dat";
...
if ($Utah_app_hh) {
	$path = "S:/urban-data/UrbanEst/Cities/Utah/App/hh";
	$setup = "setup_Utah_app_hh.dat";
...
if ($Utah_app_price) {
	$path = "S:/urban-data/UrbanEst/Cities/Utah/App/price";
	$setup = "setup_Utah_app_price.dat";
