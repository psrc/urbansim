...
class random_choices(Choices):
    def run(self, probability, resources=None):
        ...
        prob = probability/reshape(probability.sum(axis=1),(probability.shape[0],1)) ## built-in method sum of numpy.ndarray object
#        prob = probability/reshape(sum(probability,axis=1),(probability.shape[0],1)) ## numpy sum method - copied from pre4 OPUS version - added 8 jul 09
