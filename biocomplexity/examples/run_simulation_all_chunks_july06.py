...
class Simulation:
    ...
    package_path = OpusPackage().get_package_path("biocomplexity") 
    ...
    def _generate_input_land_cover(self, current_year, base_directory, 
        ...
        if not convert_flt:
            logger.start_block("Copy data from urbansim cache to temp land cover folder")
            try:
    ...
    def _generate_output_flt(self, current_year, land_cover_path, urbansim_cache_directory, 
    ...
    def run(self, base_directory, urbansim_cache_directory, years, output_directory, temp_folder,
        ...
        for year in years:
            ...
            #max_size = 17438406
            max_size = self._get_max_index(land_cover_path)
            ...
            while (s < t and t <= max_size):
                ...
                # Todo: how to get land_covers name?
                ...
                model.run(specification, coefficients, land_covers, data_objects={"gridcell":gridcells,
                              ...
                              chunk_specification = ChunkSpecification(nchunks=5))
                land_covers.flush_dataset()
                del gridcells
                del land_covers

                self._generate_output_flt(year, land_cover_path, urbansim_cache_directory, 
                                          output_directory, convert_flt)
        ...
        # clean up temp storeage after done simulation
...
if __name__ == "__main__":    
    ...
    base_dir = r"c:\eclipse\LCCM_4County/land_covers/1995"
    #base_dir = "/home/hana/data/LCCM_4County/1995"
    urbansim_cache = r"c:\urbansim_cache_sub95_99_99start"
