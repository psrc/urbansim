...
#
# This program is distributed in the hunits_proposed.pyope that it will be useful, but WITHOUT
...
class existing_units(Variable):
    ...
    """
    _return_type = "int32"
    package_name = "mag_parcel"
    
    def dependencies(self):
        return ["unit_name = parcel.disaggregate(land_use_type.unit_name)",
                "building_sqft = parcel.aggregate(mag_parcel.building.building_sqft)",
