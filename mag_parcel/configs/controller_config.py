...
#                     "weights_for_estimation_string":"urbansim.zone.number_of_non_home_based_jobs",
                     ...
                     "capacity_string":"mag_parcel.building.building_sqft",
                     "number_of_agents_string":"business.sqft",
                     "number_of_units_string":"mag_parcel.building.vacant_building_sqft",
   }
...
my_controller_configuration = {
 'real_estate_price_model': {
    ...
    "init": {
        ...
        "arguments": {"submodel_string": "'land_use_type_id'",
                      "outcome_attribute": "'ln_unit_price=ln(mag_parcel.parcel.unit_price)'",
                      "filter_attribute": "'numpy.logical_or(parcel.aggregate(mag_parcel.building.building_sqft), mag_parcel.parcel.is_land_use_type_vacant)'"
                      },
        },
    "prepare_for_run": {
    ...
    "prepare_for_estimate": {
        ...
        "arguments": {"specification_storage": "base_cache_storage",
                      "specification_table": "'real_estate_price_model_specification'",
                      "filter_variable":"'mag_parcel.parcel.unit_price'",
                      "dataset": "parcel",
                      "threshold": 1},
  ...
  "business_transition_model" : {
            "import": {"mag_parcel.models.business_transition_model":
  ...
  "business_relocation_model" : {
            ...
            "init": {
                ...
                "arguments": {
                              "probabilities":"'mag_parcel.business_relocation_probabilities'",
 ...
 'business_location_choice_model': {
    "import": {"mag_parcel.models.business_location_choice_model":"BusinessLocationChoiceModel"},
    "init": {
        ...
        "arguments": {
                      ...
                      "filter": "'mag_parcel.building.building_sqft'",
...
# the estimate method is not availible before the estimation data is ready
   ...
   #'building_transition_model': {
            #"import": {"mag_parcel.models.building_transition_model": "BuildingTransitionModel"},
...
##                          "building_types_table": "building_type",
   ...
   #'building_location_choice_model':{
                ...
                #"import": {"mag_parcel.models.building_location_choice_model":
                ...
                #"init": {
                    ...
                    #"arguments": {
                        ...
                        #"agents_grouping_attribute":"'mag_parcel.building.building_class_id'",
                        #"estimate_config" : {'weights_for_estimation_string':"'mag_parcel.parcel.uniform_capacity'"},
                        #"run_config":{"agent_units_string" : "mag_parcel.building.building_size"}
                        #}
                    #},
                #"prepare_for_run": {
                    #"name": "prepare_for_run",
...
##                                 "id_name":"['building_id','scheduled_year']",
        ...
        "process_pipeline_events":{
             "import": {"mag_parcel.models.process_pipeline_events":
...
# configuration for parcel-based developer model
 'expected_sale_price_model': {
    "import": {"mag_parcel.models.development_project_proposal_regression_model":
    ...
    "init": {
        ...
        "arguments": {"submodel_string": "'land_use_type_id=development_project_proposal.disaggregate(parcel.land_use_type_id)'", 
                      ...
                      "filter_attribute": "'mag_parcel.development_project_proposal.is_viable'",
    ...
    "prepare_for_run": {
        ...
        "arguments": {"parcel_filter":"'is_vacant_developable=numpy.logical_and(parcel.land_use_type_id==21, numpy.logical_and(parcel.plan_type_id != 18, parcel.plan_type_id != 2))'",
                      ...
                      "specification_table": "'real_estate_price_model_specification'",
                       "coefficients_storage": "base_cache_storage",
                       "coefficients_table": "'real_estate_price_model_coefficients'",
                       "spec_replace_module_variable_pair": "('mag_parcel.estimation.repm_specification', 'variables_for_development_project_proposal')",
                       "dataset_pool": "dataset_pool",},
 ...
 'development_proposal_choice_model': {
    "import": {"mag_parcel.models.development_project_proposal_sampling_model":
               "DevelopmentProjectProposalSamplingModel"},
    "init": {
        "name": "DevelopmentProjectProposalSamplingModel",
        "arguments": {"proposal_set": "proposal_set",
                      #weight_string omitted to use defalut value "exp_ROI = exp(mag_parcel.development_project_proposal.expected_rate_of_return_on_investment)",                      
 ...
 'building_construction_model': {
     "import": {"mag_parcel.models.building_construction_model":
...
hlcm_controller["init"]["arguments"]["run_config"] = {"capacity_string":"mag_parcel.building.vacant_residential_units"} #"urbansim.zone.vacant_residential_units"
...
#        'zone':{},
        #'household':{},
        'building':{},
        'parcel':{'package_name':'mag_parcel'},
#        'business':{'package_name':'mag_parcel'},
#        'person':{'package_name':'mag_parcel'},
        "building_type":{'package_name':'mag_parcel'},
#        'travel_data':{}
        }

#config["datasets_to_preload"]['business'] = {'package_name':'mag_parcel'}
