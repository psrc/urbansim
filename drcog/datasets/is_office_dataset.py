...
class IsOfficeDataset(SubgroupDataset):
    
    id_name_default = 'is_office_id'
    in_table_name_default = "is_office"
    out_table_name_default = "is_office"
    dataset_name = "is_office"
    subgroup_definition = ['drcog.building.is_office_id']
