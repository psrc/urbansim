...
aliases = [
   ...
   "total_job_spaces = safe_array_divide(drcog.employment_submarket.non_residential_sqft, drcog.employment_submarket.building_sqft_per_employee)",
   "vacant_job_spaces = clip_to_zero(drcog.employment_submarket.total_job_spaces - drcog.employment_submarket.employees)",
           ]
