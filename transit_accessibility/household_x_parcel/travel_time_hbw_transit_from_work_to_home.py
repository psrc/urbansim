...
try:
    ...
    class travel_time_hbw_transit_from_work_to_home(Variable):
        ...
        default_value = 18000
        work_parcel_id = "work_place_parcel_id"
        def dependencies(self):
            return [attribute_label("parcel","parcel_id"),
                    attribute_label("household",self.work_parcel_id),
    ...
    class TestsHouseholdParcelTravelTimeHbwTransitFromWorkToHome(opus_unittest.OpusTestCase):
        variable_name = "transit_accessibility.household_x_parcel.travel_time_hbw_transit_from_work_to_home"
