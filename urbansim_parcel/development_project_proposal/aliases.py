...
aliases = [
   ...
   "total_revenue = (urbansim_parcel.development_project_proposal.units_proposed * development_project_proposal.unit_price_expected).astype(float32)",
   ...
   "parcel_building_sqft = development_project_proposal.disaggregate(urbansim_parcel.parcel.building_sqft)",
   "acquisition_cost = urbansim_parcel.development_project_proposal.unit_price * urbansim_parcel.development_project_proposal.parcel_building_sqft",
