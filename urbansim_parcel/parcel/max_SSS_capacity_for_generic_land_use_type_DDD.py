...
class Tests(opus_unittest.OpusTestCase):
    def test_my_inputs(self):
        ...
        should_be = array([0.2, 3, 0.2])
        instance_name = 'urbansim_parcel.parcel.max_units_per_acre_capacity_for_generic_land_use_type_1'
        tester.test_is_close_for_family_variable(self, should_be, instance_name)
        
        should_be = array([6, 0, 6])
        instance_name = 'urbansim_parcel.parcel.max_units_per_lot_capacity_for_generic_land_use_type_1'
        tester.test_is_equal_for_family_variable(self, should_be, instance_name)           
