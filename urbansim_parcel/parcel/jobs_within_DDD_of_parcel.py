...
class jobs_within_DDD_of_parcel(Variable):
    """total number of jobs within radius DDD of parcel"""
    _return_type = "int32"
    ...
    def compute(self, dataset_pool):
        ...
        arr = self.get_dataset().sum_dataset_over_ids(dataset_pool.get_dataset('job'), constant=1)
...
class Tests(opus_unittest.OpusTestCase):
    def test_my_inputs(self):
        ...
        instance_name = 'urbansim_parcel.parcel.jobs_within_1_of_parcel'
