...
aliases = [
   ...
   "plan_1=parcel.plan_type_id==1",
    ...
    "is_non_residential_plan_type = (%s + %s + %s + %s + %s + %s + %s + %s + %s) > 0" % (
       ...
       "building_sqft_per_unit = safe_array_divide(urbansim_parcel.parcel.building_sqft - urbansim_parcel.parcel.nonresidential_building_sqft, urbansim_parcel.parcel.residential_units)",
       ...
       "unit_price = safe_array_divide(parcel.land_value + urbansim_parcel.parcel.improvement_value, urbansim_parcel.parcel.total_sqft)",   
       "is_land_use_type_not_vacant = numpy.logical_not(urbansim_parcel.parcel.is_land_use_type_vacant)", 
       "total_sqft = parcel.parcel_sqft*(urbansim_parcel.parcel.is_land_use_type_vacant)+urbansim_parcel.parcel.building_sqft*urbansim_parcel.parcel.is_land_use_type_not_vacant",
       #"price_per_sqft = safe_array_divide(parcel.land_value + urbansim_parcel.parcel.improvement_value, urbansim_parcel.parcel.existing_units)",   
       ...
       "is_redevelopable = (urbansim_parcel.parcel.improvement_value / ( urbansim_parcel.parcel.total_value_per_sqft * parcel.parcel_sqft) ) < 0.1" ## fake is_redevelopable attribute
           ]
