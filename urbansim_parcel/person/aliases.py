...
aliases = ['is_worker = person.employment_status > 0',
           ...
           'is_non_home_based_worker_with_placed_job = numpy.logical_and(urbansim_parcel.person.is_non_home_based_worker_with_job, urbansim_parcel.person.workplace_zone_id > 0)',
           'parcel_id = person.disaggregate(urbansim_parcel.household.parcel_id)',
           'large_area_id = person.disaggregate(urbansim_parcel.household.large_area_id)',
           ]