...
def compute_devmdl_accvars(node_set):
    ...
    node_sum_sf_price_sqft = node_set.compute_variables('node.aggregate((1)*(residential_unit.sale_price>0)*(residential_unit.disaggregate(building.building_type_id<2)),intermediates=[building,parcel])')
    node_sum_sf_price = array(node_sum_sf_price, dtype="float32")
    node_sum_sf_price_sqft = array(node_sum_sf_price_sqft, dtype="float32")
    
    node_sum_mf_price = node_set.compute_variables('node.aggregate((residential_unit.sale_price/1000)*(residential_unit.sale_price>0)*(residential_unit.disaggregate(building.building_type_id==3)),intermediates=[building,parcel])')
    ...
    node_sum_mf_price_sqft = node_set.compute_variables('node.aggregate((1)*(residential_unit.sale_price>0)*(residential_unit.disaggregate(building.building_type_id==3)),intermediates=[building,parcel])')
    ...
    node_sum_sf_rent_sqft = node_set.compute_variables('node.aggregate((1)*(residential_unit.rent>0)*(residential_unit.disaggregate(building.building_type_id<2)),intermediates=[building,parcel])')
    node_sum_sf_rent = array(node_sum_sf_rent, dtype="float32")
    node_sum_sf_rent_sqft = array(node_sum_sf_rent_sqft, dtype="float32")

    node_sum_mf_rent = node_set.compute_variables('node.aggregate((residential_unit.rent)*(residential_unit.rent>0)*(residential_unit.disaggregate(building.building_type_id==3)),intermediates=[building,parcel])')
    ...
    node_sum_mf_rent_sqft = node_set.compute_variables('node.aggregate((1)*(residential_unit.rent>0)*(residential_unit.disaggregate(building.building_type_id==3)),intermediates=[building,parcel])')
    node_sum_mf_rent = array(node_sum_mf_rent, dtype="float32")
    node_sum_mf_rent_sqft = array(node_sum_mf_rent_sqft, dtype="float32")
    
    node_sum_of_rent = node_set.compute_variables('node.aggregate((building.rent)*(building.rent>0)*(building.building_type_id==4),intermediates=[parcel])')
