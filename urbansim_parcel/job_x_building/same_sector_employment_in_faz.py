...
class same_sector_employment_in_faz(abstract_number_of_agents_with_same_attribute_value):
    """"""
        
    agent_attribute_name = "job.sector_id"
    agent_dependencies = ['urbansim_parcel.job.faz_id']
    choice_set_dependencies = ['urbansim_parcel.building.faz_id']
    #unique_agent_attribute_value = range(1, 20)
    geography_dataset_name = 'faz'
    ## use default
