...
aliases = [
   ...
   "is_untaken_non_home_based_job = numpy.logical_and(job.number_of_agents(person)==0, job.home_based_status==0)",   
   "is_untaken_home_based_job = numpy.logical_and(job.number_of_agents(person)==0, job.home_based_status==1)",
   ...
   "county_id = job.disaggregate(parcel.county_id, intermediates=[building])",
