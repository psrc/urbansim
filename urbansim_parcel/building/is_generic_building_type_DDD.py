...
class is_generic_building_type_DDD(Variable):
    ...
    def dependencies(self):
        return [my_attribute_label("generic_building_type_id")]
        
    def compute(self, dataset_pool):
        return self.get_dataset().get_attribute("generic_building_type_id") == self.building_type
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "urbansim_parcel.building.is_generic_building_type_3"
