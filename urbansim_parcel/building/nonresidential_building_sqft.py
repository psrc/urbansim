...
class nonresidential_building_sqft(Variable):
    ...
    def dependencies(self):
        return [my_attribute_label("building_class_id"),
                ...
                "urbansim_parcel.building_use.class_name"]
...
if __name__=='__main__':
    ...
    from urbansim_parcel.datasets.building_use_classification_dataset import BuildingUseClassificationDataset
    from opus_core.storage_factory import StorageFactory

    class Tests(unittest.TestCase):
        variable_name = "urbansim_parcel.building.nonresidential_building_sqft"
        def test(self):
