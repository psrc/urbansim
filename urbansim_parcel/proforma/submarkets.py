...
def setup_dataset_pool(opus=True, btype=None, submarket_info=None, esubmarket_info=None ):
    ...
    if submarket_info is not None:
        ...
        for i in xrange(proposal_comp['proposal_component_id'].size):
            ...
            submarket_sales_idx = numpy.logical_and( submarket_info['residential_building_type_id'] == bldg_type,
                                                     submarket_info['residential_building_type_id'] > 0)
            submarket_rent_idx = numpy.logical_and( submarket_info['residential_building_type_id'] == bldg_type,
                                                    submarket_info['residential_building_type_id'] > 0)
