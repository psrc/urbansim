...
class Shifters(object):
    ...
    def __init__(self):
        ...
        self.max_nonres_size = dataset_pool['max_nonres_sizes']
        self.load()
    ...
    def load(self):
        ...
        MAXNONRESSIZE_D = OrderedDict([(cnty_id, max_size) for cnty_id, max_size in
                                zip(self.max_nonres_size['county_id'], self.max_nonres_size['max_size'])])
        self.shifters['RESLOCALCOST_D'] = RESLOCALCOST_D
        self.shifters['NONRESLOCALCOST_D'] = NONRESLOCALCOST_D
        self.shifters['MAXNONRESSIZE_D'] = MAXNONRESSIZE_D

    def flush(self):
        self.price_shifters.flush_dataset()
        self.cost_shifters.flush_dataset()
        self.max_nonres_size.flush_dataset()
