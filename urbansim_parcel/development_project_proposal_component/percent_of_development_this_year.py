...
class percent_of_development_this_year(Variable):
    """
    Percent of development for the current year, according to velocity function, given start year of the project and current year.
    """
    _return_type="int32"
...
class Tests(opus_unittest.OpusTestCase):
    ...
    def test_my_inputs(self):
        ...
        should_be = array([50, 100,  25,  0, 25, 100, 50, 25])
