...
#   "construction_cost = development_project_proposal_component.disaggregate(development_template_component.construction_cost_per_unit) * urbansim_parcel.development_project_proposal_component.units_proposed",
   "component_construction_cost = development_project_proposal_component.disaggregate(urbansim_parcel.development_template_component.component_construction_cost_per_unit) * urbansim_parcel.development_project_proposal_component.units_proposed",   
