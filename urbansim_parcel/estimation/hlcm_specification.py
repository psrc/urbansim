...
#            "ln_avg_value_per_unit = ln(building.disaggregate(psrc_parcel.parcel.unit_price)/building.residential_units)",
            "ln_value_per_unit = ln(building.disaggregate(psrc_parcel.parcel.unit_price))",
            ...
            "income_x_ln_avg_value_per_unit = household.income * ln(building.disaggregate(psrc_parcel.parcel.unit_price))",
            ...
            #"income_x_sqft_bedroom = (household.income * (psrc_parcel.building.building_sqft / psrc_parcel.building.number_of_bedrooms))",
