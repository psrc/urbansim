...
class TransitionModel(Model):
    ...
    def run(self, 
        ...
        **Parameters**
                ...
                **reset_to_be_removed** : dictionary, optional. 

                        If specified, instead of removing records from dataset, flag 
                        the records with the key and value in the dictionary.
