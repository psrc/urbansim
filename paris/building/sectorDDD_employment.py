...
class sectorDDD_employment(Variable):
    ...
    def dependencies(self):
        return [
                ...
                "establishment.building_id",
                "_emp{0}=building.aggregate(establishment.is_sector{0} * establishment.not_disappeared)".format(self.sector_id)
                ]
...
class Tests(opus_unittest.OpusTestCase):
    def test_my_inputs(self):
        ...
        instance_name = 'paris.building.sector1_employment'
        should_be = array([0, 1])
        tester.test_is_equal_for_family_variable(self, should_be, instance_name)
        instance_name = 'paris.building.sector2_employment'
        should_be = array([2, 0])
        tester.test_is_equal_for_family_variable(self, should_be, instance_name)
