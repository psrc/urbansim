...
class hhpoor_lnprice(Variable):
    """Test variable for the interaction of neighborhoods and households.  
    Computes household.poor * neighborhood.ln_price."""        
    
    def dependencies(self):
        return [attribute_label("neighborhood", "ln_price"), 
                attribute_label("household", "poor")]
        
    def compute(self, dataset_pool):
        return self.get_dataset().multiply("poor", "ln_price")
