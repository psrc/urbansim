...
class hhnpam2_nbnpam2(Variable):
    """Test variable for the interaction of neighborhoods and households.  
    Computes household.poor * neighborhood.poor."""        
    
    def dependencies(self):
        return [attribute_label("neighborhood", "npam2_m"), 
                attribute_label("household", "npam2")]
        
    def compute(self, dataset_pool):
        return self.get_dataset().multiply("npam2", "npam2_m")
