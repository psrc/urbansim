...
#  
# python urbansim/tools/start_estimation.py -c eugene.configs.baseline_estimation --model=commercial_development_project_location_choice_model -s eugene.estimation.commercial_DPLCM_specification
#
# see 
...
#   
    -2:  # commercial sub_model for 1000 sqft or less
        [
#
# ###   Economic Variables:
#
