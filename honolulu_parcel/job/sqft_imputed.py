...
class sqft_imputed(Variable):
    ...
    def dependencies(self):
        return ["honolulu_parcel.job.zone_id",
                "bldgs_building_type_id = job.disaggregate(employment_submarket.building_type_id)", 
                "honolulu_parcel.job.employment_submarket_id",
                "building_sqft_per_job.building_sqft_per_job"]

    def compute(self,  dataset_pool):
        jobs = self.get_dataset()
        emp_submarkets = dataset_pool.get_dataset("employment_submarket")
