...
class ResidentialBuildingTypeDataset(SubgroupDataset):
    
    id_name_default = 'residential_building_type_id'
    in_table_name_default = "residential_building_type"
    out_table_name_default = "residential_building_type"
    dataset_name = "residential_building_type"
    subgroup_definition = ['honolulu_parcel.building.residential_building_type_id']
