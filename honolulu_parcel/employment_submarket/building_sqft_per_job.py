...
class building_sqft_per_job(Variable):
    ...
    def dependencies(self):
        return ["building_sqft_per_job.building_sqft_per_job",
                "employment_submarket.zone_id",
                "employment_submarket.building_type_id",
                ]

    def compute(self,  dataset_pool):
        sqft_per_job = dataset_pool.get_dataset("building_sqft_per_job")
        emp_submarkets = self.get_dataset()
        zones = emp_submarkets.get_attribute("zone_id")
        type_ids = emp_submarkets.get_attribute("building_type_id")
