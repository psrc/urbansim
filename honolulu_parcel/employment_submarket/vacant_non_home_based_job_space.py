...
class vacant_non_home_based_job_space(Variable):
    ...
    def dependencies(self):
        return ["emp_submarket_nonres_sqft=employment_submarket.aggregate(building.non_residential_sqft)",
                "honolulu_parcel.employment_submarket.occupied_building_sqft_by_jobs",
                "honolulu_parcel.employment_submarket.building_sqft_per_job",
                ]

    def compute(self,  dataset_pool):
        emp_submarkets = self.get_dataset()  
        non_residential_sqft = emp_submarkets.get_attribute("emp_submarket_nonres_sqft")
        building_sqft_per_job = emp_submarkets.get_attribute("building_sqft_per_job")
        remaining_space = clip(non_residential_sqft - emp_submarkets.get_attribute("occupied_building_sqft_by_jobs"),
