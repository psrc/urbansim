...
aliases = [
       ...
       "residential_building_type_id = 1*((building.residential_units>0)*(building.building_type_id==1)) + 2*((building.residential_units>0)*(building.building_type_id==2)) + 3*((building.residential_units>0)*(building.building_type_id==3))+  4*((building.residential_units>0)*(building.building_type_id>3))+ 5*(building.residential_units==0)",
       ...
       "occupied_spaces=urbansim_parcel.building.is_residential * urbansim_parcel.building.number_of_households + numpy.logical_not(urbansim_parcel.building.is_residential) * honolulu_parcel.building.number_of_non_home_based_jobs *urbansim_parcel.building.building_sqft_per_job",
