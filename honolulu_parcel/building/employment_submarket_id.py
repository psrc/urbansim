...
from honolulu_parcel.datasets.employment_submarket_dataset import EmploymentSubmarketDataset, generate_unique_ids

class employment_submarket_id(Variable):
    """ Return the employment_submarket_id of building, as defined in the datasets/submarket_dataset.py
    """
    _return_type = "int32"
    
    def dependencies(self):
        return EmploymentSubmarketDataset.subgroup_definition
