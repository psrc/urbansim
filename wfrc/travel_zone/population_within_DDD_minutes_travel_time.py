...
class population_within_DDD_minutes_travel_time(abstract_access_within_threshold_variable):
    """total population for zones within DDD minutes travel time,
    ...
    def __init__(self, number):
        ...
        self.zone_attribute_to_access = "wfrc.travel_zone.population"
...
class Tests(opus_unittest.OpusTestCase):
    def get_values(self, number):
        self.variable_name = "psrc.zone.employment_within_%s_minutes_travel_time" % number
        ...
        dataset_pool = DatasetPool(package_order=['wfrc','urbansim_zone','urbansim_parcel','urbansim'],
                                   storage=storage)
