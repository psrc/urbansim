...
from enthought.traits.ui import View, Item, Handler
from enthought.traits.ui.menu import Action, OKButton, CancelButton, Menu, MenuBar
MyAction = Action(name="test", action="do_print")

class TestHandler(Handler):
    def do_print(self,info):
        print 'setting age to 44'
        info.object.age=44
...
class Child(HasTraits):
    ...
    traits_view = View(Item(name='first_name'),   # TRAITS UI: Define
                       ...
                       Item(name='father'),
                       title="Test example",
                       menubar = MenuBar(Menu(MyAction, name = 'test menu')),
