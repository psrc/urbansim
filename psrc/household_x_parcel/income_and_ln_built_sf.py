...
class income_and_ln_built_sf(Variable):
    """ income * ln_built_sf"""
    _return_type="float32"
    parcel_built_sf = "built_sf"
    hh_income = "income"
    
    def dependencies(self):
        return ["parcel_ln_built_sf = ln(psrc.parcel.built_sf_unit)",
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.household_x_parcel.income_and_ln_built_sf"
    def test_full_tree(self):
        ...
        storage.write_table(
            ...
            table_data={
                ...
                'built_sf_unit':array([1000, 1000, 3000, 2000])
                },
        )
        storage.write_table(
