...
#               {'dataset':'large_area',
#                'image_type':'map',
#                'attribute':{'indicator_name': 'psrc.large_area.de_population_%s' % config['year'],
#                             'scale':[1,750000]
#                             }
#                },  
#               {'dataset':'large_area',
#                'image_type':'map',
#                'attribute':{'indicator_name': 'psrc.large_area.de_employment_%s' % config['year'],
#                             'scale':[1,700000]
#                             }
#                },
#                
...
#               {'dataset':'large_area',
#                'image_type':'map',
#                'attribute':{'indicator_name': 'psrc.large_area.share_of_de_population_%s' % config['year'],
#                             'scale':[0, 0.2]
#                             }
#                }, 
#               {'dataset':'large_area',
#                'image_type':'map',
#                'attribute':{'indicator_name': 'psrc.large_area.share_of_de_employment_%s' % config['year'],
#                             'scale':[0, 0.2]
#                             }
#                }, 
...
#                             'operation':'subtract',
#                             'arguments':['psrc.large_area.de_population_%s' % config['year'], 
...
#                             'operation':'subtract',
#                             'arguments':['psrc.large_area.de_employment_%s' % config['year'], 
...
#                             "operation":'subtract',
#                             "arguments":['psrc.large_area.share_of_de_population_%s' % config['year'],
...
#                             "operation":'subtract',
#                             "arguments":['psrc.large_area.share_of_de_employment_%s' % config['year'],
...
#                             'operation':'subtract',
#                             'arguments':['psrc.large_area.population', 
#                                 'psrc.large_area.de_population_%s' % config['year']],
#                             'scale':[-75000, 100000]
#                             }
#                },
#               {'dataset':'large_area',
...
#                             'operation':'subtract',
#                             'arguments':['psrc.large_area.number_of_jobs_without_resource_construction_sectors', 
#                             'psrc.large_area.de_employment_%s' % config['year']],
#                             'scale':[-50000, 25000]
#                             }
#                }, 
#                
...
#                                 'psrc.large_area.share_of_de_population_%s' % config['year']],
#                             'scale':[-0.03, 0.03]
#                             }
#                }, 
#               {'dataset':'large_area',
...
#                                  'psrc.large_area.share_of_de_employment_%s' % config['year']],
#                             'scale':[-0.02, 0.02]
#                             }
#                }, 
...
#               {'dataset':'faz',
#                 'image_type':'map',
#                 'attribute':{'indicator_name': 'psrc.faz.share_of_de_population_%s' % config['year'],
#                              'scale':[0, 0.02]
#                              }
#                },
#               {'dataset':'faz',
#                 'image_type':'map',
#                 'attribute':{'indicator_name': 'psrc.faz.share_of_de_employment_%s' % config['year'],
#                              'scale':[0, 0.1]
#                              }
#                },  
#                
#               {'dataset':'faz',
#                 'image_type':'map',
#                 'attribute':{'indicator_name': 'de_population_%s' % config['year'],
#                              'scale':[1, 60000]
#                              }
#                }, 
#               {'dataset':'faz',
#                 'image_type':'map',
#                 'attribute':{'indicator_name': 'de_employment_%s' % config['year'],
#                              'scale':[1, 150000]
#                              }
#                },    
...
#                 'attribute':{'indicator_name': 'de_population_change',
#                              'operation':'subtract',
#                              'arguments':['de_population_%s' % config['year'], 'de_population_2000'],
#                              'scale':[-8000, 40000]
#                              }
#                },
#               {'dataset':'faz',
...
#                 'attribute':{'indicator_name': 'de_employment_change',
#                              'operation':'subtract',
#                              'arguments':['de_employment_%s' % config['year'], 'de_employment_2000'],
#                              'scale':[-2000, 40000]
#                              }
#                },    
#               {'dataset':'faz',
...
#                 'attribute':{"indicator_name":'share_of_de_population_change',
#                              "operation":'subtract',
#                              "arguments":['psrc.faz.share_of_de_population_%s' % config['year'],
...
#                 'attribute':{"indicator_name":'share_of_de_employment_change',
#                              "operation":'subtract',
#                              "arguments":['psrc.faz.share_of_de_employment_%s' % config['year'],
...
#                 'attribute':{'indicator_name': 'urbansim_de_population_difference',
#                              'operation':'subtract',
#                              'arguments':['urbansim.faz.population', 'de_population_%s' % config['year']],
#                              'scale':[-30000, 30000]
#                              }
#                }, 
#               {'dataset':'faz',
...
#                              'operation':'subtract',
#                              'arguments':['psrc.faz.share_of_population', 
#                                  'psrc.faz.share_of_de_population_%s' % config['year']],
#                              'scale':[-0.01, 0.01]
#                              }
#                }, 
#               {'dataset':'faz',
...
#                              'operation':'subtract',
#                              'arguments':['psrc.faz.share_of_employment', 
#                                  'psrc.faz.share_of_de_employment_%s' % config['year']],
#                              'scale':[-0.01, 0.01]
#                              }
#                },
