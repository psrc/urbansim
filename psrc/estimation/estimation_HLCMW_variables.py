...
#            ("urbansim.gridcell.ln_residential_units_within_walking_distance","LUW"),
            ("urbansim.gridcell.ln_service_sector_employment_within_walking_distance","LSEW"),
            ("urbansim.gridcell.ln_basic_sector_employment_within_walking_distance","LBEW"),
            ("urbansim.gridcell.ln_retail_sector_employment_within_walking_distance","LREW"),
