...
class trip_weighted_average_time_hbw_from_home_am_drive_alone(Abstract_Trip_Weighted_Average_Variable_From_Home):
    """ Trip weighted average time from home to any workplace for 
    home-based-work am trips by auto.
    """
    def __init__(self):
        Abstract_Trip_Weighted_Average_Variable_From_Home.__init__(self, time_attribute_name = "am_single_vehicle_to_work_travel_time",
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.zone.trip_weighted_average_time_hbw_from_home_am_drive_alone"
