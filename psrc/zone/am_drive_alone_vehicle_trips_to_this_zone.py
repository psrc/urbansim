...
class am_drive_alone_vehicle_trips_to_this_zone(abstract_aggregate_travel_data_variable):
    """
    Calculate the sum of drive alone trips ending in each zone.
    """
    ...
    aggregate_by_origin = False  #whether the aggregate_zone_id is origin zone
    travel_data_attribute = 'travel_data.am_pk_period_drive_alone_vehicle_trips'                
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.zone.am_drive_alone_vehicle_trips_to_this_zone"
