...
class trip_mode_walk(AbstractTripMode):
    """ Trips on a bike"""
    def __init__(self):
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.zone.trip_mode_walk"
    ...
    def test_my_inputs(self):
        ...
        storage.write_table(
            ...
            table_data={
                ...
                "hbw_daily_walking_person_trip_table": array([1.1, 2.2, 3.3, 4.4]),
                "college_daily_walking_person_trip_table": array([1.0, 2.0, 3.0, 4.0]),
                "hbnw_daily_walking_person_trip_table": array([2.0, 3.0, 1.0, 0.0]),
                "nhb_daily_walking_person_trip_table": array([12.8, 4.5, 1.2, 8.0]),
            }
        )
