...
class trip_weighted_average_time_hbw_to_work_am_transit_walk(Abstract_Trip_Weighted_Average_Variable_To_Work):
    """ Trip weighted average time from home to any workplace for 
    home-based-work am trips by transit.
    """
    def __init__(self):
        Abstract_Trip_Weighted_Average_Variable_To_Work.__init__(self, time_attribute_name = "am_total_transit_time_walk",
