...
class trip_weighted_average_generalized_cost_hbw_to_work_am_drive_alone(Abstract_Trip_Weighted_Average_Variable_To_Work):
    """ Trip weighted average generalized cost from home to any work for 
    home-based-work am trips by auto.
    """
    def __init__(self):
        Abstract_Trip_Weighted_Average_Variable_To_Work.__init__(self, time_attribute_name = "single_vehicle_to_work_travel_cost",
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.zone.trip_weighted_average_generalized_cost_hbw_to_work_am_drive_alone"
