...
class mode_split_park_ride_trips_over_all(AbstractModeSplit):
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.zone.mode_split_park_ride_trips_over_all"
    ...
    def test_my_inputs(self):
        ...
        should_be = array([3.0/27.0, 2.0/35.0])
