...
class generalized_cost_weighted_access_to_employment_hbw_am_transit_walk(abstract_weighted_access):
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.zone.generalized_cost_weighted_access_to_employment_hbw_am_transit_walk"
