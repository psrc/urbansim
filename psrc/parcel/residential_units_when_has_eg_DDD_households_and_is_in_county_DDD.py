...
class residential_units_when_has_eg_DDD_households_and_is_in_county_DDD(Variable):
    """"""
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.parcel.residential_units_when_has_eg_2_households_and_is_in_county_033"
