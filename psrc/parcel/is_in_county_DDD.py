...
class is_in_county_DDD(Variable):
    """Returns a boolean indicating if the parcel is in DDD coded county
    ...
    def dependencies(self):
        return [my_attribute_label("county")]

    def compute(self, dataset_pool):
        counties = self.get_dataset().get_attribute("county")
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.parcel.is_in_county_033"
