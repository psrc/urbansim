...
class home_parcel_id(Variable):
    """The parcel_id of a person's residence."""
    ...
    def compute(self, dataset_pool):
        ...
        return self.get_dataset().get_join_data(households, name="parcel_id")
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.person.home_parcel_id"
