...
class head_of_household(Variable):
    """if a person is head of the household"""

    def dependencies(self):
        return [my_attribute_label("relation")]
        
    def compute(self, dataset_pool):
        persons = self.get_dataset()
        return persons.get_attribute("relation") == 1
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.person.head_of_household"
