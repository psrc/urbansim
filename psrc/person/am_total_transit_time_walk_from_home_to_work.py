...
class am_total_transit_time_walk_from_home_to_work(abstract_travel_time_variable_for_non_interaction_dataset):
    """Travel time from home zone to work zone.
    The travel time used is for the home-based-work total transit walk time.
    """
    default_value = 999
    origin_zone_id = 'psrc.person.home_zone_id'
    destination_zone_id = 'psrc.person.work_place_zone_id'
    travel_data_attribute = 'travel_data.am_total_transit_time_walk'
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.person.am_total_transit_time_walk_from_home_to_work"
