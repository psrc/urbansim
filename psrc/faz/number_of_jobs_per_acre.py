...
class number_of_jobs_per_acre(Variable):
    """Number of jobs in faz / number of acres in faz"""
    _return_type="int32"
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.faz.number_of_jobs_per_acre"
 
    def test_my_inputs(self):
        number_of_jobs = array([21,22,27,42]) 
        acres_of_land = array([1.0,2.0,1.0,2.0])
        some_gridcell_faz_ids = array([1,2,1,3]) 
