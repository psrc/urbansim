...
class workerDDD_am_total_transit_time_walk_from_home_to_work(abstract_travel_time_variable):
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.household_x_gridcell.worker1_am_total_transit_time_walk_from_home_to_work"
    ...
    def test_my_inputs(self):
        ...
        should_be = array([[3.3, 3.3, 1.1, 0.7], [4.4, 4.4, 2.2, 8.7],
                           [4.4, 4.4, 2.2, 8.7], [default_value, default_value, default_value, default_value],
