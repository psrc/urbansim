...
class income_and_am_total_transit_time_walk_from_home_to_work(Variable):
    ...
    def dependencies(self):
        return ["psrc.person_x_job." + self.travel_time,
                "psrc.person.household_income"]
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.person_x_job.income_and_am_total_transit_time_walk_from_home_to_work"
