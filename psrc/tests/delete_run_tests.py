...
class DeleteRunsTests(opus_unittest.OpusIntegrationTestCase):
    ...
    def test_delete_some_years(self):            
        ...
        self.assertTrue(os.path.exists(os.path.join(cache_dir, '2000')))
        path = module_path_from_opus_path('opus_core.tools.delete_run')
        ...
        self.assertTrue(os.path.exists(cache_dir))
        self.assertTrue(os.path.exists(os.path.join(cache_dir, '2000')))
        self.assertTrue(not os.path.exists(os.path.join(cache_dir, '2001')))
        self.assertTrue(not os.path.exists(os.path.join(cache_dir, '2002')))
        self.assertTrue(os.path.exists(os.path.join(cache_dir, '2003')))
        self.assertTrue(os.path.exists(os.path.join(cache_dir, '2004')))
        ...
        self.assertTrue(not os.path.exists(os.path.join(cache_dir, '2001')))
        self.assertTrue(not os.path.exists(os.path.join(cache_dir, '2002')))
        self.assertTrue(not os.path.exists(os.path.join(cache_dir, '2003')))
        self.assertTrue(os.path.exists(os.path.join(cache_dir, '2004')))
