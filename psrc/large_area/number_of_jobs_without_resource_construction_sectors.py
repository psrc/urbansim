...
class number_of_jobs_without_resource_construction_sectors(Variable):
    ...
    def dependencies(self):
        return [attribute_label("faz", "large_area_id"), 
                "psrc.faz.number_of_jobs_without_resource_construction_sectors", 
    ...
    def compute(self, dataset_pool):
        ...
        return self.get_dataset().sum_over_ids(faz.get_attribute("large_area_id"), 
                                   faz.get_attribute("number_of_jobs_without_resource_construction_sectors"))

    def post_check(self, values, dataset_pool):
        size = dataset_pool.get_dataset('faz').get_attribute("number_of_jobs_without_resource_construction_sectors").sum()
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.large_area.number_of_jobs_without_resource_construction_sectors"
