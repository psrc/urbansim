...
class trip_weighted_average_time_hbw_from_home_am_drive_alone(Variable):
    ...
    def compute(self, dataset_pool):
        ...
        return self.get_dataset().get_join_data(zones, "trip_weighted_average_time_hbw_from_home_am_drive_alone")
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.gridcell.trip_weighted_average_time_hbw_from_home_am_drive_alone"
    ...
    def test_my_inputs(self):
        ...
        storage.write_table(
            ...
            table_data={
                'zone_id': array([1, 2, 3]),
                "trip_weighted_average_time_hbw_from_home_am_drive_alone": array([4.1, 5.3, 6.2]),
            }
        )
