...
class trip_weighted_average_generalized_cost_hbw_to_work_am_drive_alone(Variable):
    ...
    def compute(self, dataset_pool):
        ...
        return self.get_dataset().get_join_data(zones, "trip_weighted_average_generalized_cost_hbw_to_work_am_drive_alone")
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.gridcell.trip_weighted_average_generalized_cost_hbw_to_work_am_drive_alone"
