...
class trip_weighted_average_time_hbw_from_home_am_bike(Variable):
    ...
    def compute(self, dataset_pool):
        ...
        return self.get_dataset().get_join_data(zones, "trip_weighted_average_time_hbw_from_home_am_bike")
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.gridcell.trip_weighted_average_time_hbw_from_home_am_bike"
