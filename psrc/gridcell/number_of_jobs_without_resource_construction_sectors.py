...
class number_of_jobs_without_resource_construction_sectors(Variable):
    ...
    def dependencies(self):
        ...
        return ["urbansim.gridcell.number_of_jobs",
                "urbansim.gridcell.number_of_jobs_of_sector_1",
                "urbansim.gridcell.number_of_jobs_of_sector_2"]

    def compute(self, dataset_pool):
        return self.get_dataset().get_attribute("number_of_jobs") - \
               self.get_dataset().get_attribute("number_of_jobs_of_sector_1") - \
               self.get_dataset().get_attribute("number_of_jobs_of_sector_2")

    def post_check(self, values, dataset_pool):
        maxv = dataset_pool.get_dataset('gridcell').get_attribute("number_of_jobs").max()
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc.gridcell.number_of_jobs_without_resource_construction_sectors"
    ...
    def test_my_inputs(self):
        ...
        values = VariableTestToolbox().compute_variable(self.variable_name, \
            { "gridcell":{
                  ...
                  "number_of_jobs":jobs,
                  "number_of_jobs_of_sector_1":sector_1_jobs,
                  "number_of_jobs_of_sector_2":sector_2_jobs
                  }},
              dataset = "gridcell" )
