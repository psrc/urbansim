...
my_controller_configuration["workplace_location_choice_model_for_immigrant"]["init"]["arguments"]["model_name"] = "'Non-home-based Work Choice Model for immigrants'"
...
my_controller_configuration["workplace_location_choice_model_for_immigrant"]["run"]["arguments"]["agents_filter"] = "'psrc.person.is_immigrant_worker_without_job'"
