...
class units_proposed(Variable):
    ...
    def dependencies(self):
        return [
                "_units_proposed_in_proposal = development_project_proposal_component.disaggregate(az_smart.development_project_proposal.units_proposed)",
                "_is_far_unit = development_project_proposal_component.disaggregate(az_smart.development_template.is_far)",
