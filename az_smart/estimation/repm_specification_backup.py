...
specification = {  
    ...
    "constant",
#    "building.year_built",
    "ln_bldgage=ln(az_smart.building.age_masked)",
#    "ln_bldgage2=(ln(az_smart.building.age_masked))**2",
#    "ln_bldgage3=(ln(az_smart.building.age_masked))**3",
    "lnsqft=ln(az_smart.building.building_sqft)",
#    "far=building.building_sqft/building.disaggregate(parcel.parcel_sqft)",
    "ln_invfar=ln(building.disaggregate(parcel.parcel_sqft)/az_smart.building.building_sqft)",
#    "building.stories",
...
#    "beds=building.number_of_bedrooms/building.residential_units",
    "lnbedsqft=ln(az_smart.building.building_sqft/building.number_of_bedrooms)",
#    "baths=building.number_of_bathrooms",
    "lnsqftunit=ln(az_smart.building.building_sqft/building.residential_units)",
#    "far=building.building_sqft/building.disaggregate(parcel.parcel_sqft)",
    "far=az_smart.building.building_sqft/building.disaggregate(parcel.parcel_sqft)",
#    "building.stories",        
