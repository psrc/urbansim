\documentclass{sig-alternate-preprint}
\usepackage{url}
\sloppy

\begin{document}

\toappear{\large{To appear in \emph{Proceedings of the ACM International
Symposium on Software Testing and Analysis, July 2006, Portland, Maine}.}}
