...
observed_share_var = []
sampled_share_var = []
for k, v in observed_shares.items():
...
aliases = [
      ...
      "census_2020_block_group_id = building.disaggregate(census_2020_block.census_2020_block_group_id, intermediates=[parcel])",
      "census_block_id = building.disaggregate(parcel.census_block_id)",
      "census_2020_block_id = building.disaggregate(parcel.census_2020_block_id)",
      ...
      "census_2020_tract_id = building.disaggregate(census_2020_block_group.census_2020_tract_id, intermediates=[census_2020_block, parcel])",      
