...
aliases = [
           ...
           "is_head_white = household.aggregate((person.relate == 1)*(person.race_id == 1))",
           "is_head_hispanic = household.aggregate((person.relate == 1)*(person.race_id > 5))",
           "is_head_black = household.aggregate((person.relate == 1)*(person.race_id == 2))",
           "is_head_asian = household.aggregate((person.relate == 1)*(person.race_id == 3))",
           "persons_white = household.aggregate(person.race_id == 1)",
           "persons_non_white = household.aggregate(person.race_id > 1)",
