...
class workerDDD_network_distance_from_home_to_work(abstract_travel_time_variable_for_non_interaction_dataset):
    """network_distance_from_home_to_work"""
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc_parcel.household.worker1_network_distance_from_home_to_work"
