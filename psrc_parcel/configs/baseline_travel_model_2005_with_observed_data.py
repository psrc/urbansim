...
class BaselineTravelModel2005WithObservedData(Baseline):
    ...
    def __init__(self):
        ...
        travel_model_configuration = create_travel_model_configuration('baseline_travel_model_psrc_fast_hana', 
                                                                       ...
                                                                       mode='full', years_to_run={2005: '2005_06'})
        ...
        config['travel_model_configuration'][2005]['models'] = config['travel_model_configuration'][2005].get('models')
        config['travel_model_configuration'][2005]['models'].append('opus_emme2.models.restore_trip_tables')
        self.merge(config)
