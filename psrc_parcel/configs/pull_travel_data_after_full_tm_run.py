...
class PullTravelDataAfterFullTmRun(Baseline):
    def __init__(self):
        config = Baseline()

        config_changes = {
            'description':'run travel model for baseyear and then extract travel data',
            'models':[],
            'models_in_year': {2000:[],},
            'years': (2000,2001),
        }
        ...
        travel_model_configuration = create_travel_model_configuration('baseline_travel_model_psrc_2008_lmwang', 
                                                                       ...
                                                                       mode='full', years_to_run={2000: '2000_v1.0aTG',
                                                                                                  2005: '2006_v1.0aTG',
                                                                                                  2010: '2010_v1.0aTG', 
