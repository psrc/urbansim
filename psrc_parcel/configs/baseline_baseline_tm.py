...
class BaselineBaselineTm(Baseline):
    tm_scenario = '/urbansim_cache/travel_model/baseline_v1.0bb'
    multiple_runs=False
    def __init__(self):
        config = Baseline()
        config_changes = {
        ...
        config['creating_baseyear_cache_configuration'].baseyear_cache.existing_cache_to_copy = r'/urbansim_cache/psrc_parcel/base_year_data/baseline'
