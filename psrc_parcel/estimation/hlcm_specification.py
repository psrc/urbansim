...
#             "psrc_parcel.building.building_sqft",              
             "psrc_parcel.building.building_sqft_per_unit",
             ...
             "building:opus_core.func.disaggregate(psrc_parcel.zone.employment_within_60_minutes_bus_travel_time,[parcel]) as employment_within_60_minutes_bus_travel_time",             
             ...
             "building:opus_core.func.disaggregate(psrc_parcel.zone.employment_of_sector_cie,[parcel]) as ln_employment_of_sector_cie_in_zone",             
            ],
2:   #submodel
          [        
             "building:opus_core.func.ln(building.residential_units) as ln_residential_units",
...
#             "psrc_parcel.building.building_sqft_per_unit",
             "building:opus_core.func.disaggregate(psrc_parcel.zone.number_of_households,[parcel]) as households_in_zone",
#             "building:opus_core.func.disaggregate(psrc_parcel.zone.employment_within_10_minutes_bus_travel_time,[parcel]) as employment_within_10_minutes_bus_travel_time",             
             "building:opus_core.func.disaggregate(parcel.area) as lot_area",             
             "building:opus_core.func.disaggregate(psrc_parcel.zone.employment_within_60_minutes_bus_travel_time,[parcel]) as employment_within_60_minutes_bus_travel_time",             
#             "building:opus_core.func.disaggregate(psrc_parcel.zone.employment_within_20_minutes_hwy_travel_time,[parcel]) as employment_within_20_minutes_hwy_travel_time",             
