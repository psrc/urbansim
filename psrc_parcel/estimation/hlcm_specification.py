...
specification = {
        0:   #submodel_id
            ...
            "ln_avg_building_sf_per_unit = ln(urbansim_parcel.building.building_sqft/building.residential_units)",
#            "ln_avg_value_per_unit = ln(building.disaggregate(urbansim_parcel.parcel.unit_price)/building.residential_units)",
            "ln_value_per_unit = ln(building.disaggregate(urbansim_parcel.parcel.unit_price))",
            ...
            "income_x_ln_avg_value_per_unit = household.income * ln(building.disaggregate(urbansim_parcel.parcel.unit_price))",
            ...
            "persons_x_ln_avg_building_sf_per_unit = household.persons * ln(urbansim_parcel.building.building_sqft/building.residential_units)",
