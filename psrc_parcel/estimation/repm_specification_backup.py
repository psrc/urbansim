...
#    "ln_bldgage2=(ln(urbansim_parcel.building.age_masked))**2",
#    "ln_bldgage3=(ln(urbansim_parcel.building.age_masked))**3",
...
#    "beds=building.number_of_bedrooms/building.residential_units",
    "lnbedsqft=ln(urbansim_parcel.building.building_sqft/building.number_of_bedrooms)",
#    "baths=building.number_of_bathrooms",
    "lnsqftunit=ln(urbansim_parcel.building.building_sqft/building.residential_units)",
#    "far=building.building_sqft/building.disaggregate(parcel.parcel_sqft)",
    "far=urbansim_parcel.building.building_sqft/building.disaggregate(parcel.parcel_sqft)",
#    "building.stories",        
