...
all_variables = [
    ...
    "far=(parcel.aggregate(urbansim_parcel.building.building_sqft)/parcel.parcel_sqft).astype(float32)",
    ...
    "lnemp30da=(ln(parcel.disaggregate(psrc_parcel.zone.employment_within_30_minutes_travel_time_hbw_am_drive_alone))).astype(float32)",
    "lnemp20da=(ln(parcel.disaggregate(psrc_parcel.zone.employment_within_20_minutes_travel_time_hbw_am_drive_alone))).astype(float32)",
    "lnemp10da=(ln(parcel.disaggregate(psrc_parcel.zone.employment_within_10_minutes_travel_time_hbw_am_drive_alone))).astype(float32)",
    "lnemp30tw=(ln(parcel.disaggregate(psrc_parcel.zone.employment_within_30_minutes_travel_time_hbw_am_transit_walk))).astype(float32)",
    "lnemp20tw=(ln(parcel.disaggregate(psrc_parcel.zone.employment_within_20_minutes_travel_time_hbw_am_transit_walk))).astype(float32)",
    "lnemp10wa=(ln(parcel.disaggregate(psrc_parcel.zone.employment_within_10_minutes_travel_time_hbw_am_walk))).astype(float32)",
    "lnemp20wa=(ln(parcel.disaggregate(psrc_parcel.zone.employment_within_20_minutes_travel_time_hbw_am_walk))).astype(float32)",
