...
all_variables = [
    ...
    "lnsqftunit=ln(parcel.aggregate(urbansim_parcel.building.building_sqft)/parcel.aggregate(building.residential_units))",
    "lnlotsqft=ln(parcel.parcel_sqft)",
    "lnunits=ln(parcel.aggregate(building.residential_units))",
    "lnlotsqftunit=ln(parcel.parcel_sqft/parcel.aggregate(building.residential_units))",
    "ln_invfar=ln(parcel.parcel_sqft/parcel.aggregate(urbansim_parcel.building.building_sqft))",
    ...
    "lnempden=ln(parcel.disaggregate(urbansim_parcel.zone.number_of_jobs_per_acre))",
#    "lnempden=ln(parcel.disaggregate(zone.number_of_agents(job)/(zone.aggregate(parcel.parcel_sqft) / 43560.0)))",
    "lnpopden=ln(parcel.disaggregate(urbansim_parcel.zone.population_per_acre))",
...
variables_for_development_project_proposal = {
      'ln_bldgage' : 'ln(urbansim_parcel.development_project_proposal.building_age)',
      'lnsqft': 'ln(urbansim_parcel.development_project_proposal.building_sqft)',
      "lnsqftunit": 'ln(urbansim_parcel.development_project_proposal.building_sqft/urbansim_parcel.development_project_proposal.units_proposed)',
      "lnlotsqftunit": "ln(development_project_proposal.aggregate(parcel.parcel_sqft)/urbansim_parcel.development_project_proposal.units_proposed)",
      "ln_invfar": "ln(development_project_proposal.aggregate(parcel.parcel_sqft)/urbansim_parcel.development_project_proposal.building_sqft)",
                                              }
specification ={}
specification = {
