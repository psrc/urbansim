...
##HLCM specification with  variables from control function
all_variables = [
###################################################################################
    ### BEGIN variable defintion
             "a_residential_units = ln(psrc_parcel.building.residential_units)",             
             "b_same_area_type = (urbansim_parcel.household.residence_area_type_id_lag1 == building.disaggregate(zone.area_type_id))",
             "c_same_area = (urbansim_parcel.household.residence_large_area_id_lag1 == building.disaggregate(faz.large_area_id))",
             ...
             "f_ln_inc_x_size = ln_bounded(urbansim.household.income) * ln(psrc_parcel.building.sqft_per_unit)",
             ...
             "j_inc_x_SFR = ln(household.income) * urbansim.building.is_single_family_residential",
             "k_inc_x_MFR = ln(household.income) * urbansim.building.is_multi_family_residential",
             "l_persons_x_size = (household.persons) * urbansim.building.sqft_per_unit",
             "building.sqft_per_unit",
             ...
             "q_0workers_x_avg_work_logsum = (household.workers==0) * ( ((psrc.household.logsum_income_break==1) * building.disaggregate(psrc.zone.trip_weighted_average_logsum_hbw_am_income_1)) + ((psrc.household.logsum_income_break==2) * building.disaggregate(psrc.zone.trip_weighted_average_logsum_hbw_am_income_2)) + ((psrc.household.logsum_income_break==3) * building.disaggregate(psrc.zone.trip_weighted_average_logsum_hbw_am_income_3)) + ((psrc.household.logsum_income_break==4) * building.disaggregate(psrc.zone.trip_weighted_average_logsum_hbw_am_income_4)) )",
...
##          ("urbansim_parcel.household_x_building.ln_sampling_probability_for_bias_correction_mnl_vacant_residential_units", "bias", 1),
       ...
       ##ALTERNATIVE
             ...
             "i_unit_price = urbansim_parcel.building.unit_price * urbansim_parcel.building.building_sqft_per_unit",
             #"i_low_inc_x_unit_price = urbansim.household.is_low_income*urbansim_parcel.building.unit_price*urbansim_parcel.building.building_sqft_per_unit",
             #"i_mid_inc_x_unit_price = urbansim.household.is_mid_income*urbansim_parcel.building.unit_price*urbansim_parcel.building.building_sqft_per_unit",
             #"i_high_inc_x_unit_price = urbansim.household.is_high_income*urbansim_parcel.building.unit_price * urbansim_parcel.building.building_sqft_per_unit",
             "i_unit_price_100k = urbansim_parcel.building.unit_price * urbansim_parcel.building.building_sqft_per_unit / 100000",
             "i_ln_unit_price = ln_bounded( urbansim_parcel.building.unit_price * urbansim_parcel.building.building_sqft_per_unit )",

             "iv_price_residual = urbansim_parcel.building.price_residual",
             "iv_ln_price_residual = urbansim_parcel.building.ln_price_residual",
...
###################################################################################
    ### variables defined above can be used in specification by referring its shortname
]
    ...
    -2:   #submodel_id
            [
             "a_residential_units",             
                ...
                "i_unit_price",
                #"i_ln_unit_price",
                #"i_low_inc_x_unit_price",
                #"i_mid_inc_x_unit_price",
                #"i_high_inc_x_unit_price",
                "iv_price_residual",
                #"iv_ln_price_residual",
                #   #"j_inc_x_condo",
                #   #"j_inc_x_SFR",
                "k_inc_x_MFR",
                #"l_persons_x_size",
