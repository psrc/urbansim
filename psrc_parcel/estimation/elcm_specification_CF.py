...
##ELCM specification with  variables from control function
all_variables = [
...
#    "ln_job_sqft_x_bldg_sqft_per_job = ln(urbansim_parcel.job.sqft_imputed * urbansim_parcel.building.building_sqft_per_job)"
            ...
            "i_unit_price = urbansim_parcel.building.unit_price",
            "unit_price_10k = urbansim_parcel.building.unit_price/10000",
            "i_ln_unit_price = ln_bounded( urbansim_parcel.building.unit_price )",

            "iv_price_residual = urbansim_parcel.building.unit_price_residual",
            "iv_ln_price_residual = urbansim_parcel.building.ln_unit_price_residual",
            "iv_uprice_residual = urbansim_parcel.building.price_residual",
            "iv_ln_uprice_residual = urbansim_parcel.building.ln_price_residual",
