...
all_variables = [
    ...
    "lnlotsqftunit=ln(urbansim_parcel.building.parcel_sqft/building.residential_units)",
    "ln_invfar=ln(urbansim_parcel.building.parcel_sqft/urbansim_parcel.building.building_sqft)",
    ...
    "is_commercial_building = urbansim_parcel.building.building_type_name == 'commercial'",
    "is_industrial_building = urbansim_parcel.building.building_type_name == 'industrial'",
    "is_office_building = urbansim_parcel.building.building_type_name == 'office'",
    "is_mixed_use_building = urbansim_parcel.building.building_type_name == 'mixed_use'",
    "is_sfh_building = urbansim_parcel.building.building_type_name == 'single_family_residential'",
    "is_mfh_building = urbansim_parcel.building.building_type_name == 'multi_family_residential'",
