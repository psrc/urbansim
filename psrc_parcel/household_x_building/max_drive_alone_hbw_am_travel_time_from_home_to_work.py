...
class max_drive_alone_hbw_am_travel_time_from_home_to_work(Variable):
    ...
    def dependencies(self):
        return [ 
                "psrc_parcel.household_x_building.worker1_drive_alone_hbw_am_travel_time_from_home_to_work",
                "psrc_parcel.household_x_building.worker2_drive_alone_hbw_am_travel_time_from_home_to_work",
             ]

    def compute(self, dataset_pool):
        interaction_dataset = self.get_dataset()
        data1 = interaction_dataset.get_attribute("worker1_drive_alone_hbw_am_travel_time_from_home_to_work")
        data2 = interaction_dataset.get_attribute("worker2_drive_alone_hbw_am_travel_time_from_home_to_work")
