...
class max_drive_alone_hbw_am_travel_time_from_home_to_work_if_worker_not_use_transit(Variable):
    """max_drive_alone_hbw_am_travel_time_from_home_to_work_if_worker_not_use_transit between worker1 & worker2"""
    
    def dependencies(self):
        return [ 
                "psrc_parcel.household_x_building.worker1_drive_alone_hbw_am_travel_time_from_home_to_work_if_worker_not_use_transit",
                "psrc_parcel.household_x_building.worker2_drive_alone_hbw_am_travel_time_from_home_to_work_if_worker_not_use_transit",
             ]

    def compute(self, dataset_pool):
        interaction_dataset = self.get_dataset()
        data1 = interaction_dataset.get_attribute("worker1_drive_alone_hbw_am_travel_time_from_home_to_work_if_worker_not_use_transit")
        data2 = interaction_dataset.get_attribute("worker2_drive_alone_hbw_am_travel_time_from_home_to_work_if_worker_not_use_transit")
