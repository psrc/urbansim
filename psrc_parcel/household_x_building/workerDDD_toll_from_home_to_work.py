...
class workerDDD_toll_from_home_to_work(abstract_travel_time_variable):
    """single vehicle toll from the centroid of home zone to that of work zone"""
    ...
    def __init__(self, number):
        ...
        self.travel_data_attribute = "urbansim.travel_data.am_single_vehicle_to_work_toll"
