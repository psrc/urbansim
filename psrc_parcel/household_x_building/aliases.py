...
aliases = [
    ...
    "avg_trip_weighted_zone_logsum = ((psrc_parcel.household.income_breaks_25000_51000_78000==1) * building.disaggregate(psrc.zone.trip_weighted_average_logsum_hbw_am_income_1)) + ((psrc_parcel.household.income_breaks_25000_51000_78000==2) * building.disaggregate(psrc.zone.trip_weighted_average_logsum_hbw_am_income_2)) + ((psrc_parcel.household.income_breaks_25000_51000_78000==3) * building.disaggregate(psrc.zone.trip_weighted_average_logsum_hbw_am_income_3)) + ((psrc_parcel.household.income_breaks_25000_51000_78000==4) * building.disaggregate(psrc.zone.trip_weighted_average_logsum_hbw_am_income_4))",
