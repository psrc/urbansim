...
class network_distance_between_worker1_worker2_workplaces(abstract_travel_time_variable):
    ...
    agent_zone_id = "(person.worker1==1) * (psrc_parcel.person.workplace_of_worker2) + (person.worker2==1) * (psrc_parcel.person.workplace_of_worker1)"
...
class Tests(opus_unittest.OpusTestCase):
    variable_name = "psrc_parcel.person_x_job.network_distance_from_home_to_work"
