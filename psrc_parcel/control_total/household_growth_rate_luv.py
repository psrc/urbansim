    ...
    def compute(self, dataset_pool):
        ...
        for i in range(ct.size()):
            ...
            if curr_val.size == 0 or next_val.size == 0:
                ...
                results[i] = ( next_val.sum() - curr_val.sum()) / float(curr_val.sum()) 
...
class Tests(opus_unittest.OpusTestCase):
    def test_my_inputs(self):
        ...
        defval = household_growth_rate_luv.GROWTH_RATE_FOR_NO_MATCH
        should_be = array([defval, defval, (7-5)/5., (11-6)/6., defval, defval, defval, defval, defval])
