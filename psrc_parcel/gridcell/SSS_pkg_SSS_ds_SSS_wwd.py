...
class SSS_pkg_SSS_ds_SSS_wwd(Variable):
    ...
    for a dataset given by the second SSS) 
        ...
        E.g. psrc_parcel.gridcell.urbansim_pkg_household_ds_population_wwd
        computes variable population urbansim.gridcell.population and sums it over gridcells within walking distance,
