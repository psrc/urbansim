...
if __name__ == "__main__":
    ...
    #result_directory = "d:/opusgit/urbansim_data/data/psrc_parcel/runs/bm_44_7runs"
    #result_directory = "d:/opusgit/urbansim_data/data/psrc_parcel/runs/bm_54_55"
    #result_directory = "d:/opusgit/urbansim_data/data/psrc_parcel/runs/bm_54_55_57_58"
    #result_directory = "d:/opusgit/urbansim_data/data/psrc_parcel/runs/bm_57_58"
    #result_directory = "d:/opusgit/urbansim_data/data/psrc_parcel/runs/bmHH_74_5runs"
    #result_directory = "d:/opusgit/urbansim_data/data/psrc_parcel/runs/bm_78_5runs"
    result_directory = "d:/opusgit/urbansim_data/data/psrc_parcel/runs/bm_138_4runs"
    ...
    variables = {"households": {"zone": "urbansim_parcel.zone.number_of_households",
                 ...
                 "population": {"zone": "urbansim_parcel.zone.population",
                                ...
                                "fips_rgs": "population = fips_rgs.aggregate(urbansim_parcel.parcel.population, intermediates=[city])"}                
                 }

    geos = ["zone", "faz", "city", "fips_rgs"]
    geos = ["faz", "city", "fips_rgs"]
    observed_data = {}
    known_output = {}
    bmgeos = {}
    for geo in geos:
        ...
        known_output[geo] = [
            ...
            {
                'variable_name': variables["population"][geo], # What variable does the observed data correspond to
                'filename': "ofm_pop17_%s" % geo, # In what file are values of this variable
                #'transformation': "sqrt", # What transformation should be performed (can be set to None)
                'transformation': "**(1/3.)",
                # Other arguments of the class ObservedDataOneQuantity (in bayesian_melding.py) can be set here. See its doc string.
                #'filter': "urbansim_parcel.zone.number_of_households", 
