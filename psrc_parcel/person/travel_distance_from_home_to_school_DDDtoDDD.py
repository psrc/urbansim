...
class travel_distance_from_home_to_school_DDDtoDDD(abstract_travel_data_h5_income_variable_DDDtoDDD):
    """Travel distance from home to school obtained from hdf5 skims. Time periods can be 
        given in the variable name, e.g. travel_distance_from_home_to_school_6to8.
