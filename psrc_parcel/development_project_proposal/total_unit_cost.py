...
class total_unit_cost(Variable):
    """total unit cost of the proposed developmentt project
    """

    def dependencies(self):
        return ["psrc_parcel.proposed_development_project.per_unit_cost",
                    'psrc_parcel.proposed_development_project.proposed_units']

    def compute(self, dataset_pool):
        self.get_dataset().compute_variable('total_unit_cost=per_unit_cost * proposed_units')
        return self.get_dataset().get_attribute("total_unit_cost")
