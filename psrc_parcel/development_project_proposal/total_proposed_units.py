...
class total_proposed_units(Variable):
    """total proposed units (residential units, and/or non residential sqft) for the proposed developmentt project,
    depending on whether the proposed projects will be prorated or not, part or all of the 
    units will be available
    """

    def dependencies(self):
        return ["lot_size = diaggregate(psrc_parcel.parcel.lot_size)",
