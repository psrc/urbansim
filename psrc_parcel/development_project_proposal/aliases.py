...
aliases = [
          ...
          #  This is the actual term called in the Project XML file - two above are defining variables used below
            ...
            # HB 1110
            "units_proposed_hb1110 = numpy.maximum(psrc_parcel.development_project_proposal.units_proposed_plus_minimum_1DU_per_legal_lot_yield, numpy.logical_and(%s, %s))" % (
             ...
             "total_investment = (development_project_proposal.disaggregate((parcel.aggregate((psrc_parcel.development_project_proposal.total_revenue - urbansim_parcel.development_project_proposal.construction_cost), function=maximum)))*.91+ urbansim_parcel.development_project_proposal.construction_cost).astype(float32)",
