...
aliases = [
           ...
           "SC_occupied_spaces_1 = urbansim_parcel.building.occupied_residential_units * 1.2",
           "SC_occupied_spaces_0 = zurich_parcel.building.occupied_non_residential_spaces * 2.4",
