...
class vacant_non_home_based_job_space(Variable):
    ...
    def dependencies(self):
        return ["urbansim_parcel.building.non_residential_sqft",
                "zurich_parcel.building.occupied_non_residential_spaces",
    ...
    def compute(self,  dataset_pool):
        ...
        remaining_space = clip(non_residential_sqft - buildings.get_attribute("occupied_non_residential_spaces"),
                               0, non_residential_sqft)
        return ma.filled(ma.masked_where(building_sqft_per_job==0, remaining_space), 0)
