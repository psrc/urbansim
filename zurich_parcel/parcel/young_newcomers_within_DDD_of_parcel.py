...
class young_newcomers_within_DDD_of_parcel(abstract_variable_within_radius_DDD_of_parcel):
    """total number of persons with wo5m>1 within radius DDD of parcel"""
    _return_type = "int32"
    
    quantity = "_newcomers = parcel.aggregate(numpy.logical_and(person.wo5m>1, person.age<30), intermediates=[household, building])"
