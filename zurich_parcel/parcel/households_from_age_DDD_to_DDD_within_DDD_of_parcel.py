...
class households_from_age_DDD_to_DDD_within_DDD_of_parcel(abstract_variable_within_radius_DDD_of_parcel):
    ...
    def __init__(self, min_age, max_age, radius):
        self.quantity = "_nhouseholds_from_age_%s_to_%s = parcel.aggregate(numpy.logical_and(household.age_of_head>%s ,household.age_of_head<%s) , intermediates=[living_unit, building])" % (min_age, max_age, min_age, max_age)
