# This is based on urbansim_parcel/building/building_sqft_per_job
# It uses sector_id instead of building_type in get_building_sqft_table
...
class BuildingSqftPerJobDataset(UrbansimDataset):
    ...
    id_name_default = ["zone_id","sector_id"]
    ...
    def get_building_sqft_as_table(self, zone_max=0, building_type_max=0):
        """Return a 2-d array (zone.max x sector_id.max) filled with values from 
        ...
        bts = self.get_attribute("sector_id")
