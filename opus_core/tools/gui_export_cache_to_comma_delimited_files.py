...
from enthought.traits import HasTraits, Directory
from enthought.traits.ui import View, Group, Item


class ExportCSVConfig(HasTraits):
    ...
    view = View(
        ...
        kind = 'modal',
        title = 'Export UrbanSim Baseyear Cache to Comma Delimited Files',
        ok=True, apply=False, undo=False, revert=False, help=False,
        )
    
if __name__ == '__main__':
    args = ExportCSVConfig()
    ...
    from opus_core.tools.do_export_cache_to_comma_delimited_files import __file__ as script_path
