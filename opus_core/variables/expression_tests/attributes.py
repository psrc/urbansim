...
class Tests(opus_unittest.OpusTestCase):
    ...
    def test_fully_qualified_variable(self):
        ...
        self.assertTrue(ma.allclose(result, should_be, rtol=1e-6), "Error in test_fully_qualified_variable")
        ...
        self.assertTrue(expr in cache, msg="did not find expr in cache")
        ...
        self.assertTrue(expr_with_spaces not in cache, msg="caching error")
    ...
    def test_fully_qualified_DDD_SSS_variable(self):
        ...
        self.assertTrue(ma.allclose(result, should_be, rtol=1e-6), "Error in test_fully_qualified_DDD_SSS_variable")
        # check that the access methods for the variable all return the correct values
        name = VariableName(expr)
        self.assertEqual(name.get_package_name(), 'opus_core', msg="bad value for package")
        ...
        self.assertTrue(ma.allclose(result2, should_be, rtol=1e-6), "Error in accessing a_test_squid_variable_42_clam")
