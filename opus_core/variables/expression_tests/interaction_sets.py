...
class Tests(opus_unittest.OpusTestCase):
    ...
    def test_multiply(self):
        ...
        should_be = array([[1000, 2000], 
                           [20000, 40000], 
                           [500000, 1000000]])
        self.assertTrue(ma.allclose(result, should_be, rtol=1e-6), msg = "Error in " + expr)
        ...
        self.assertTrue('test_agent' in names)
        self.assertTrue('test_location' in names)
    ...
    def test_interaction_set_component(self):
        ...
        self.assertTrue(ma.allclose(result2, should_be, rtol=1e-6), msg = "Error in " + expr)
        ...
        self.assertTrue(ma.allclose(result3, should_be, rtol=1e-6), msg = "Error in " + expr)
