...
class VariableFactory(object):
    ...
    It should be used by calling the method 'get_variable'.  Each variable should be implemented as a
    class with a name of the variable which should be placed in a module of the same name as the class.  
    ...
    def get_variable(self, variable_name, dataset, quiet=False, debug=0, index_name=None):
        ...
        if variable_name.get_autogen_class() is None:
