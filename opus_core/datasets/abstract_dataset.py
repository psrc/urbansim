...
class AbstractDataset(object):
    ...
    _coordinate_system = None  # Override in child, if needed.
    ...
    def get_data_element_by_id(self, id, all_attributes=False):
        """Return an object of class DataElement of the given id. See get_data_element."""
    ...
    def subset(self, n, is_random=False):
        """The method shrinks the size of the dataset so that the number
        of each array in 'set' is 'n'.
    ...
    def set_values_of_one_attribute(self, attribute, values, index=None):
        """Replace values in 'set' of the given attribute and index by a copy of values
    ...
    def touch_attribute(self, name):
        """Pretends that the attribute was changed."""
    ...
    def set_value_of_attribute_by_id(self, attribute, value, id):
        """Replace a value in 'set' that correspond to the given identifier 'id'
        by the given 'value'.
        """
    ...
    def get_attribute_as_column(self, name):
        """ Return values of the attribute 'name' as a column vector.
        """
...
#        return [key for key in self.attribute_boxes.keys() if self.attribute_boxes[key].get_type() == AttributeType.PRIMARY]
    ...
    def get_known_attribute_names(self):
        """Return attribute names that are either in memory or primary."""
    ...
    def join(self, dataset, name, join_attribute=None, new_name=None, metadata=AttributeType.COMPUTED):
        ...
        'name' can be either a character string or a list of char strings, if join is performed
    ...
    def remove_elements(self, index):
        ...
        lazy loading, all attributes are loaded from storage."""
    ...
    def add_elements(self, data, require_all_attributes=True, change_ids_if_not_unique=False):
        ...
        of the new rows are modified to unique ids.
        """
    ...
    def get_2d_attribute(self, attribute=None, attribute_data=None):
        """Returns an 2d array of the attribute given.
        """
...
#            classification.deserialize(d)
    ...
    def get_filtered_index(self, filter, threshold=0, index=None, dataset_pool=None, resources=None):
        """Return only those indices of index that pass through the given filter."""
