...
aliases = [
           ...
           "employment =  zone.aggregate((job.job_id>0), intermediates=[building,parcel])",
           ...
           "retailjobs = zone.aggregate((numpy.in1d(job.sector_id,[44,45])), intermediates=[building,parcel])",
           "eatdrinkjobs = zone.aggregate((job.sector_id==722), intermediates=[building,parcel])",
