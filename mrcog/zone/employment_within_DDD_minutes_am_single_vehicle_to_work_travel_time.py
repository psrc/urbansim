...
class employment_within_DDD_minutes_am_single_vehicle_to_work_travel_time(abstract_access_within_threshold_variable):
    ...
    def __init__(self, number):
        ...
        self.zone_attribute_to_access = "mrcog.zone.number_of_jobs"
